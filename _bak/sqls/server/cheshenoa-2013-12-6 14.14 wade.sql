...
CREATE TABLE `app_card` (
  ...
  `member_base_id` int(10) unsigned NOT NULL COMMENT '隶属会员ID',
  `card_number` char(30) NOT NULL COMMENT '会员卡号',
  `type` char(10) NOT NULL COMMENT '卡号类型',
  `start_date` date default NULL COMMENT '开始日期',
  `stop_date` date default NULL COMMENT '结束日期',
  `is_used` tinyint(1) unsigned NOT NULL default '0' COMMENT '是否使用：0未使用，1已使用，2已过期',
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态：0正常-2删除',
  PRIMARY KEY  (`id`),
  UNIQUE KEY `card_number` (`card_number`),
  KEY `card_number_2` (`card_number`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='会员卡片记录' AUTO_INCREMENT=8 ;

-- 
-- 导出表中的数据 `app_card`
-- 

INSERT INTO `app_card` VALUES (4, 14, 'CN07552013EH123456', 'H', NULL, NULL, 0, 0);
INSERT INTO `app_card` VALUES (5, 15, 'QEWQEWQEWQEWQEWQE', 'G', NULL, NULL, 0, 0);
INSERT INTO `app_card` VALUES (6, 16, 'CN07552013EH1234561', 'G', NULL, NULL, 0, 0);
INSERT INTO `app_card` VALUES (7, 17, 'CN07552013EH123123', 'H', NULL, NULL, 0, 0);
...
CREATE TABLE `app_cars` (
  `id` smallint(6) unsigned NOT NULL auto_increment COMMENT '车辆ID',
  `company_id` smallint(5) unsigned NOT NULL COMMENT '公司区域id',
  `cars_grade_id` smallint(5) unsigned NOT NULL COMMENT '车辆级别ID',
  `brand` varchar(20) NOT NULL COMMENT '车辆品牌',
  `car_num` varchar(20) default NULL COMMENT '车牌号码',
  `type` varchar(20) NOT NULL COMMENT '车辆类型',
  `color` varchar(10) NOT NULL COMMENT '车辆颜色',
  `master` varchar(20) NOT NULL COMMENT '车辆主人',
  `buy_data` date NOT NULL COMMENT '购买日期',
  `buy_num` smallint(5) unsigned NOT NULL COMMENT '购买单位',
  `buy_cost` int(10) unsigned NOT NULL COMMENT '购买价格',
  `initial_km` varchar(10) NOT NULL COMMENT '初始公里数',
  `department` varchar(30) NOT NULL COMMENT '所属部门(与系统部门无关系)',
  `engine_num` varchar(30) NOT NULL COMMENT '发动机型号',
  `frame_num` varchar(30) NOT NULL COMMENT '车架号',
  `seat_num` tinyint(2) unsigned NOT NULL COMMENT '座位数',
  `remarks` text COMMENT '备注',
  `car_status` tinyint(1) unsigned NOT NULL default '0' COMMENT '车辆状况(0123，依次类推)：正常、维修中、报废、租用中',
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态：0正常，-2删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='车辆信息表' AUTO_INCREMENT=10007 ;

-- 
-- 导出表中的数据 `app_cars`
-- 

INSERT INTO `app_cars` VALUES (10000, 1, 4, '玛莎拉蒂', '粤GA9900', '总裁', '白色', '车神集团', '2013-10-02', 2, 2, '初始公里数', '所属部门', '发动机号', '车架号', 0, 'kkk', 0, 0);
INSERT INTO `app_cars` VALUES (10001, 1, 4, '兰博基尼', '粤GA9901', '盖拉多', '黑色', '车辆所有人', '2013-10-09', 12, 10, '初始公里数', '所属部门', '发动机号', '车架号', 4, 'ada', 0, 0);
INSERT INTO `app_cars` VALUES (10003, 1, 1, '宝马', '粤GA1103', 'Z4', '红色', '车辆所有人', '2013-10-10', 2, 123, '初始公里数', '所属部门', '发动机号', '车架号', 92, 'asdasda', 1, 0);
INSERT INTO `app_cars` VALUES (10004, 1, 1, '劳斯莱斯', '粤GA9904', '幻影', '车辆颜色', '车辆所有人', '2013-10-29', 2, 2, '初始公里数', '所属部门', '发动机号', '车架号', 2, '备注', 0, 0);
INSERT INTO `app_cars` VALUES (10005, 1, 1, '车辆品牌', '车牌号码', '车辆类型', '车辆颜色', 'wqe', '2013-11-22', 2, 3, '初始公里数', '所属部门', '发动机号', '车架号', 2, '备注', 3, -2);
INSERT INTO `app_cars` VALUES (10006, 1, 4, '法拉利599', '粤B88888', '跑车', '红色', '车神集团', '2013-04-18', 755, 4800000, '0', '运营中心', 'F140C', 'cs0012', 2, '发动机型号：F140C\r\n排量（mL）：5999\r\n进气形式：自然吸气\r\n气缸排列形式：V\r\n气缸数（个）：12\r\n每缸气门数（个）：4\r\n压缩比：11.2\r\n配气机构：DOHC\r\n缸径：92\r\n冲程：75.2\r\n最大马力（Ps）：620\r\n最大功率（kW）：456\r\n最大功率转速（rpm）：7600\r\n最大扭矩（N·m）：608\r\n最大扭矩转速（rpm）：5600\r\n燃料形式：汽油\r\n燃油标号：98号\r\n供油方式：多点电喷\r\n缸盖材料：铝\r\n缸体材料：铝\r\n环保标准：欧IV', 0, 0);
...
CREATE TABLE `app_cars_audit` (
  `id` int(10) unsigned NOT NULL auto_increment COMMENT '主键',
  `cars_id` smallint(6) unsigned NOT NULL COMMENT '车辆ID',
  `year_audit_date` date NOT NULL COMMENT '年审日期',
  `year_audit_item` varchar(30) NOT NULL COMMENT '年审项目',
  `year_audit_state` varchar(10) NOT NULL COMMENT '年审状态',
  `year_audit_next` date NOT NULL COMMENT '下次年审日期',
  `remarks` text COMMENT '备注',
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态：0正常-2删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='车辆年审表' AUTO_INCREMENT=4 ;

-- 
-- 导出表中的数据 `app_cars_audit`
-- 

INSERT INTO `app_cars_audit` VALUES (1, 10000, '2013-11-14', '是否', '年审情况', '2013-11-22', 'qwewqe1111111', 0);
INSERT INTO `app_cars_audit` VALUES (2, 10000, '2013-11-03', '项目二', '通过', '2013-11-22', 'wqqweqwe', 0);
INSERT INTO `app_cars_audit` VALUES (3, 10000, '2013-11-27', '年审项目', '年审情况', '2013-11-26', 'aaa', 0);
...
CREATE TABLE `app_cars_grade` (
  `id` smallint(5) unsigned NOT NULL auto_increment COMMENT '主键',
  `identifying` char(20) NOT NULL COMMENT '标识',
  `name` varchar(30) NOT NULL COMMENT '名称',
  `car_number` tinyint(3) unsigned NOT NULL COMMENT '允许使用天数',
  `content` varchar(255) default NULL COMMENT '内容',
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态：0正常，-2删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='车辆级别表' AUTO_INCREMENT=6 ;

-- 
-- 导出表中的数据 `app_cars_grade`
-- 

INSERT INTO `app_cars_grade` VALUES (1, '50', '50万级别豪车', 80, '', 0);
INSERT INTO `app_cars_grade` VALUES (2, '100', '100万级别豪车', 80, '', 0);
INSERT INTO `app_cars_grade` VALUES (3, '200', '200万级别豪车', 80, '', 0);
INSERT INTO `app_cars_grade` VALUES (4, '400', '400万级别豪车', 80, '', 0);
INSERT INTO `app_cars_grade` VALUES (5, '800', '800万级别豪车', 80, '', 0);

-- --------------------------------------------------------

-- 
-- 表的结构 `app_cars_insurance`
-- 

CREATE TABLE `app_cars_insurance` (
  `id` int(10) unsigned NOT NULL auto_increment COMMENT '主键',
  `cars_id` smallint(6) unsigned NOT NULL COMMENT '车辆ID',
  `insurance_start_date` date NOT NULL COMMENT '入保时间',
  `insurance_company` varchar(30) NOT NULL COMMENT '保险公司',
  `insurance_state` varchar(10) NOT NULL COMMENT '投保状态',
  `insurance_item` varchar(30) NOT NULL COMMENT '投保项目',
  `insurance_stop` date NOT NULL COMMENT '出保日期',
  `remarks` text COMMENT '备注',
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态：0正常-2删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='车辆保险报' AUTO_INCREMENT=3 ;

-- 
-- 导出表中的数据 `app_cars_insurance`
-- 

INSERT INTO `app_cars_insurance` VALUES (1, 10000, '2013-11-20', 'werwer', 'qwe', '投保项目', '2013-11-26', 'sdfsdf', 0);
INSERT INTO `app_cars_insurance` VALUES (2, 10000, '2013-11-28', '保险公司', '投保情况', '投保项目', '2013-11-26', 'sfsdfd', 0);
...
CREATE TABLE `app_cars_photo` (
  `id` int(10) NOT NULL auto_increment COMMENT '主键',
  `cars_id` smallint(6) unsigned NOT NULL COMMENT '基本信息ID',
  `type` tinyint(2) unsigned NOT NULL COMMENT '图片类型',
  `url` varchar(30) NOT NULL COMMENT '图片地址',
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态：0正常-2删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='车辆照片' AUTO_INCREMENT=10 ;

-- 
-- 导出表中的数据 `app_cars_photo`
-- 

INSERT INTO `app_cars_photo` VALUES (1, 10000, 1, '20131029/526f7f71ec42b.jpg', -2);
INSERT INTO `app_cars_photo` VALUES (2, 10000, 1, '20131029/526f7f72125b6.jpg', -2);
INSERT INTO `app_cars_photo` VALUES (3, 10000, 2, '20131029/526f7fa21066a.png', -2);
INSERT INTO `app_cars_photo` VALUES (4, 10000, 2, '20131029/526f7fa2193ee.png', -2);
INSERT INTO `app_cars_photo` VALUES (5, 10001, 1, '20131029/526f86bd94ac9.png', 0);
INSERT INTO `app_cars_photo` VALUES (6, 10001, 2, '20131029/526f86cd31d49.png', 0);
INSERT INTO `app_cars_photo` VALUES (7, 10004, 1, '20131031/52714e31ac780.jpg', 0);
INSERT INTO `app_cars_photo` VALUES (8, 10004, 2, '20131031/52714e373932e.jpg', 0);
INSERT INTO `app_cars_photo` VALUES (9, 10004, 2, '20131031/52714e4abe7b5.png', 0);

-- --------------------------------------------------------

-- 
-- 表的结构 `app_cars_schedule`
-- 

CREATE TABLE `app_cars_schedule` (
  `id` int(10) unsigned NOT NULL auto_increment COMMENT '主键',
  `cars_id` smallint(6) unsigned NOT NULL COMMENT '车辆ID',
  `title` varchar(30) NOT NULL COMMENT '标题内容',
  `start_schedule_time` int(11) unsigned NOT NULL COMMENT '开始安排时间',
  `over_schedule_time` int(11) unsigned NOT NULL COMMENT '结束安排时间',
  `time` int(11) unsigned NOT NULL COMMENT '添加时间',
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态0正常，-2删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='车辆日程安排表' AUTO_INCREMENT=9 ;

-- 
-- 导出表中的数据 `app_cars_schedule`
-- 

INSERT INTO `app_cars_schedule` VALUES (1, 10000, '车辆A，日程1', 1385361000, 1385454600, 1385361330, 0);
INSERT INTO `app_cars_schedule` VALUES (3, 10000, '车辆A，日程2', 1385457600, 1385478000, 1385361491, 0);
INSERT INTO `app_cars_schedule` VALUES (4, 10000, '车辆A，日程3', 1385481600, 1385823600, 1385361580, 0);
INSERT INTO `app_cars_schedule` VALUES (5, 10001, '车辆B，安排1', 1385537100, 1385553000, 1385451232, 0);
INSERT INTO `app_cars_schedule` VALUES (6, 10001, '车辆B，安排2', 1385724300, 1385823000, 1385451258, 0);
INSERT INTO `app_cars_schedule` VALUES (7, 10003, '敬皓天预定', 1387584000, 1387756800, 1385827894, 0);
INSERT INTO `app_cars_schedule` VALUES (8, 10003, '庚总预订车辆，宝马、宾礼', 1386288000, 1386547200, 1385828169, 0);
...
CREATE TABLE `app_company` (
  ...
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态：0正常，-2删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='公司区域表' AUTO_INCREMENT=5 ;

-- 
-- 导出表中的数据 `app_company`
-- 

INSERT INTO `app_company` VALUES (1, '深圳', 6, 'b', 0);
...
CREATE TABLE `app_department` (
  ...
  `company_id` tinyint(3) NOT NULL COMMENT '区域id',
  `name` varchar(20) NOT NULL COMMENT '名称',
  `principal` varchar(15) NOT NULL COMMENT '负责人',
  `remarks` text COMMENT '备注',
  `create_time` int(11) unsigned NOT NULL COMMENT '创建时间',
  `status` tinyint(4) NOT NULL default '0' COMMENT '状态：-2删除。0启用',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='部门管理表' AUTO_INCREMENT=21 ;

-- 
-- 导出表中的数据 `app_department`
-- 

INSERT INTO `app_department` VALUES (1, 1, '董事会', '张倬赫', '董事会成员', 1381461275, -2);
INSERT INTO `app_department` VALUES (2, 1, '企划部', '王兆辉', NULL, 1381461275, -2);
INSERT INTO `app_department` VALUES (3, 1, '行政部', '韩福华', NULL, 1381461275, -2);
INSERT INTO `app_department` VALUES (4, 1, '车辆管理中心', '宋晓航', NULL, 1381461275, 0);
INSERT INTO `app_department` VALUES (5, 1, '秘书处', '韩艳艳', NULL, 1381461275, -2);
INSERT INTO `app_department` VALUES (6, 1, '人力资源部', '谢舜娟', NULL, 1381461275, -2);
INSERT INTO `app_department` VALUES (7, 1, '财务部', '周杨', NULL, 1381461275, -2);
INSERT INTO `app_department` VALUES (8, 1, '客服部', '王兆辉', 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaasdfffffffffffffffffffffffffffffffffffffffffffffffffffffafdsfsf', 1381461275, -2);
INSERT INTO `app_department` VALUES (9, 1, '资产运营部', '沈君', NULL, 1381461275, -2);
INSERT INTO `app_department` VALUES (10, 1, '营销中心', '蒋明', NULL, 1381461275, -2);
...
INSERT INTO `app_group` VALUES (1, 0, 'Admin', '管理系统', 1380957533, 1380957533, 0);
INSERT INTO `app_group` VALUES (2, 0, 'Home', '前台系统', 1380957553, 1380957553, 0);
INSERT INTO `app_group` VALUES (3, 0, 'Api', '接口系统', 1380957569, 1380957569, 0);
INSERT INTO `app_group` VALUES (15, 1, '人力资源部', '人力资源部', 1381493027, 1381493027, 0);
INSERT INTO `app_group` VALUES (30, 1, 'Public-(后台公开组)', '公开组', 1381493899, 1381493899, 0);
...
CREATE TABLE `app_group_node` (
  ...
  KEY `nodeId` (`node_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='组与节点关系表' AUTO_INCREMENT=161 ;

-- 
-- 导出表中的数据 `app_group_node`
-- 

INSERT INTO `app_group_node` VALUES (74, 27, 1);
INSERT INTO `app_group_node` VALUES (70, 15, 1);
INSERT INTO `app_group_node` VALUES (99, 28, 25);
INSERT INTO `app_group_node` VALUES (48, 30, 19);
INSERT INTO `app_group_node` VALUES (69, 15, 20);
INSERT INTO `app_group_node` VALUES (47, 30, 17);
INSERT INTO `app_group_node` VALUES (42, 30, 1);
INSERT INTO `app_group_node` VALUES (46, 30, 18);
INSERT INTO `app_group_node` VALUES (134, 27, 9);
INSERT INTO `app_group_node` VALUES (68, 15, 25);
INSERT INTO `app_group_node` VALUES (45, 30, 15);
INSERT INTO `app_group_node` VALUES (43, 30, 14);
INSERT INTO `app_group_node` VALUES (44, 30, 16);
INSERT INTO `app_group_node` VALUES (133, 27, 8);
INSERT INTO `app_group_node` VALUES (132, 27, 7);
INSERT INTO `app_group_node` VALUES (131, 27, 6);
INSERT INTO `app_group_node` VALUES (130, 27, 5);
INSERT INTO `app_group_node` VALUES (127, 27, 4);
INSERT INTO `app_group_node` VALUES (95, 28, 1);
INSERT INTO `app_group_node` VALUES (113, 28, 26);
INSERT INTO `app_group_node` VALUES (98, 28, 35);
INSERT INTO `app_group_node` VALUES (101, 28, 33);
INSERT INTO `app_group_node` VALUES (102, 28, 34);
INSERT INTO `app_group_node` VALUES (103, 28, 31);
INSERT INTO `app_group_node` VALUES (104, 28, 32);
INSERT INTO `app_group_node` VALUES (105, 29, 1);
INSERT INTO `app_group_node` VALUES (106, 29, 25);
INSERT INTO `app_group_node` VALUES (107, 29, 35);
INSERT INTO `app_group_node` VALUES (108, 29, 26);
INSERT INTO `app_group_node` VALUES (109, 29, 29);
INSERT INTO `app_group_node` VALUES (110, 29, 30);
INSERT INTO `app_group_node` VALUES (111, 29, 28);
INSERT INTO `app_group_node` VALUES (112, 29, 27);
INSERT INTO `app_group_node` VALUES (137, 27, 14);
INSERT INTO `app_group_node` VALUES (138, 27, 16);
INSERT INTO `app_group_node` VALUES (139, 27, 20);
INSERT INTO `app_group_node` VALUES (140, 27, 25);
INSERT INTO `app_group_node` VALUES (141, 27, 10);
INSERT INTO `app_group_node` VALUES (142, 27, 11);
INSERT INTO `app_group_node` VALUES (143, 27, 12);
INSERT INTO `app_group_node` VALUES (144, 27, 13);
INSERT INTO `app_group_node` VALUES (145, 27, 36);
INSERT INTO `app_group_node` VALUES (146, 27, 37);
INSERT INTO `app_group_node` VALUES (147, 27, 38);
INSERT INTO `app_group_node` VALUES (148, 27, 39);
INSERT INTO `app_group_node` VALUES (149, 27, 40);
INSERT INTO `app_group_node` VALUES (150, 29, 14);
INSERT INTO `app_group_node` VALUES (151, 29, 15);
INSERT INTO `app_group_node` VALUES (152, 29, 36);
INSERT INTO `app_group_node` VALUES (153, 29, 37);
INSERT INTO `app_group_node` VALUES (154, 29, 38);
INSERT INTO `app_group_node` VALUES (155, 27, 21);
INSERT INTO `app_group_node` VALUES (156, 27, 22);
INSERT INTO `app_group_node` VALUES (157, 27, 23);
INSERT INTO `app_group_node` VALUES (158, 27, 24);
...
CREATE TABLE `app_group_user` (
  ...
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='组与用户关系表' AUTO_INCREMENT=26 ;

-- 
-- 导出表中的数据 `app_group_user`
-- 

INSERT INTO `app_group_user` VALUES (13, 27, 2);
INSERT INTO `app_group_user` VALUES (17, 28, 3);
INSERT INTO `app_group_user` VALUES (16, 29, 5);
INSERT INTO `app_group_user` VALUES (18, 30, 2);
INSERT INTO `app_group_user` VALUES (19, 30, 3);
INSERT INTO `app_group_user` VALUES (20, 30, 5);
INSERT INTO `app_group_user` VALUES (24, 15, 5);
INSERT INTO `app_group_user` VALUES (22, 15, 2);
INSERT INTO `app_group_user` VALUES (23, 15, 3);
INSERT INTO `app_group_user` VALUES (25, 1, 1);
...
INSERT INTO `app_member` VALUES (1, 'user1', '测试用户一', 'e10adc3949ba59abbe56e057f20f883e', 0, NULL, 0, 0, 0, 0, 0);
INSERT INTO `app_member` VALUES (2, 'user2', '测试用户二', 'e10adc3949ba59abbe56e057f20f883e', 0, NULL, 0, 0, 0, 0, 0);
INSERT INTO `app_member` VALUES (3, 'user3', 'dsfsf', '4297f44b13955235245b2497399d7a93', 1382514687, '192.168.1.102', 0, 1382514687, 1382516829, 0, 0);
...
CREATE TABLE `app_member_base` (
  `id` int(10) NOT NULL auto_increment COMMENT '主键',
  `member_id` int(10) unsigned NOT NULL COMMENT '注册用户id',
  `member_rank_id` smallint(5) unsigned NOT NULL COMMENT '会员等级ID',
  `area` varchar(20) default NULL COMMENT '投资区域',
  `source` tinyint(2) unsigned NOT NULL COMMENT '会员来源',
  `source_content` varchar(30) NOT NULL COMMENT '来源内容',
  ...
  `identity_number` varchar(18) default NULL COMMENT '证件号码',
  `passport_number` varchar(10) default NULL COMMENT '护照号码',
  `driving_number` varchar(20) default NULL COMMENT '驾驶证',
  `travel_number` varchar(20) default NULL COMMENT '行驶证号码',
  `driving_years` tinyint(3) unsigned NOT NULL default '0' COMMENT '驾龄',
  `email` varchar(20) default NULL COMMENT '电子邮箱地址',
  `enterprise_name` varchar(30) default NULL COMMENT '企业名称',
  `property` varchar(60) default NULL COMMENT '性质',
  `registered_fund` decimal(9,0) default NULL COMMENT '注册资金',
  `legal_person` varchar(20) default NULL COMMENT '法人',
  `member_group` varchar(50) default NULL COMMENT '会员组成员',
  ...
  `collaborate` varchar(255) default NULL COMMENT '企业主要 合作方',
  `product` varchar(255) default NULL COMMENT '主要经营产品',
  `distribution` varchar(255) default NULL COMMENT '产品产地分布',
  `occupancy` varchar(20) default NULL COMMENT '市场占有率',
  `direction` text COMMENT '业务发展规划',
  `contacts` varchar(20) default NULL COMMENT '紧急联系人',
  `relation` varchar(20) default NULL COMMENT '关系',
  `contacts_phone` varchar(20) default NULL COMMENT '手机号码',
  `date` date NOT NULL COMMENT '入会日期',
  `over_date` date NOT NULL COMMENT '会员结束日期',
  `use_car_number` double(9,1) unsigned NOT NULL COMMENT '会员期间内使用车辆天数。',
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态0正常，1删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='会员基本资料' AUTO_INCREMENT=18 ;

-- 
-- 导出表中的数据 `app_member_base`
-- 

INSERT INTO `app_member_base` VALUES (6, 3, 1, '深圳', 2, '敬皓天', '王兆辉', '男', '13828450426', '13828450426', '0755-22201088', '498798', '456456465465465', '', '56456', 'sdfsfsfsdf', 5, '', '', '股份公司,个人经营,有限公司', 0, '', '', 0, '', '', '', '', '', '1', '', '', '', '', '', '', '2013-11-05', '2014-11-05', 7.5, 0);
INSERT INTO `app_member_base` VALUES (7, 1, 2, 'sdfsdf', 2, 'sdfdsf', 'sdfsdfsdf', '男', '12312312313', '12312312', '12321321', '213123', '235659456456456456', '', '45646', '45645', 2, '', '', '股份公司,有限公司,有限责任公司', 0, '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '2013-11-05', '2014-11-05', 0.0, 0);
INSERT INTO `app_member_base` VALUES (8, 1, 3, 'sdfsdf', 2, 'sdfdsf', 'sdfsdfsdf', '男', '12312312313', '12312312', '12321321', '213123', '235659456456456456', '', '45646', '45645', 1, '', '', '股份公司,有限公司,有限责任公司', 0, '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '2013-11-05', '2014-11-05', 0.0, 0);
INSERT INTO `app_member_base` VALUES (9, 2, 4, '投资区域', 3, '自主', '会员姓名', '女', '11111111111', '123456', '234234', '498798', '456456465465465', 'qweqweqw', '123123123123', 'qweqw', 2, 'aa@qq.com', '企业名称', '股份公司,有限公司,有限责任公司', 100000000, '法人', '会员组成成员', 200000000, 'http://www.baidu.com', '通讯地址', '企业所处行业位置', '个人介绍及社会身份', '企业主要合作方', '主要经营产品', '产品产地分布', '市场占有率', '业务发展规划', '紧急联系人', '关 系', '手机号码', '2013-11-05', '2014-11-05', 11.0, 0);
INSERT INTO `app_member_base` VALUES (10, 2, 5, 'ada', 2, 'adasd', 'sdfsdf', '女', '11111111111', 'asdasd', '234234', '123123123123', '456456465465465', 'qweqweqw', '123123123123', 'qweqw', 4, 'asd252392785@163.com', '', '个人经营,有限责任公司', 100, 'sdfsd', 'sdfs', 200, 'http://www.baidu.com', 'gdfg', 'dgdf', '个人介绍及社会身份', '企业主要合作方', '主要经营产品', '产品产地分布', '市场占有率', '业务发展规划', '紧急联系人', ' 系', '手机号码', '2013-11-05', '2014-11-05', 0.0, 0);
INSERT INTO `app_member_base` VALUES (11, 1, 9, '深圳', 1, '16期', '庚宇彬', '男', '18818888788', '18818888788', '0755-22201088', '1158293543', '220122198106014623', '4', '45646', '45645', 5, '', '', NULL, 0, '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '2013-11-05', '2014-11-05', 4.0, 0);
INSERT INTO `app_member_base` VALUES (12, 1, 7, 'sfsdf', 2, 'sfsdf', '123456', '女', '12345678991', '123123', '123123123', '49456564', '456456465465465', 'fghfghf', '123123123123', 'qweqw', 6, '', '', NULL, 0, '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '2013-11-05', '2014-11-05', 0.0, 0);
INSERT INTO `app_member_base` VALUES (13, 1, 4, 'sdfsdf', 2, 'sdfdsf', 'qwe', '女', '12312312313', '12312312', '12321321', '213123', '235659456456456456', '', '45646', '45645', 7, '', '', NULL, 0, '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '2013-11-05', '2014-11-05', 0.0, 0);
INSERT INTO `app_member_base` VALUES (14, 1, 1, 'adasd', 2, 'sdfdsf', 'qeww', '男', '12312312313', '13712345678', '12321321', '213123', '235659456456456456', '', '45646', '45645', 3, '', '', NULL, 0, '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '2013-11-05', '2014-11-05', 0.0, 0);
INSERT INTO `app_member_base` VALUES (15, 1, 9, '深圳', 1, '文华16期', '敬皓天', '男', '18817698688', '18817698688', '0755-22201088', '1158293543', '220122198106014623', '', '45646', '45645', 4, '', '', NULL, 0, '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '2013-11-05', '2014-11-05', 0.0, 0);
INSERT INTO `app_member_base` VALUES (16, 1, 9, '深圳', 1, '文华16期', '张倬赫', '男', '18818888588', '18818888588', '0755-22201088', '213123', '220122198106014623', '', '45646', '45645', 1, '', '', NULL, 0, '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '2013-10-30', '2014-11-05', 0.0, 0);
INSERT INTO `app_member_base` VALUES (17, 2, 1, '投资区域', 2, 'aaaa', '会员姓名', '女', '12345678991', 'asdasd', '234234', '49456564', 'werwerwerwerewrew', 'aaa', '123123123123', 'qweqw', 10, '', '', NULL, 0, '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '2013-11-05', '2014-11-25', 0.0, 0);
...
CREATE TABLE `app_member_credit` (
  `id` int(10) NOT NULL auto_increment COMMENT '主键',
  ...
  `car` varchar(255) default NULL COMMENT '最高级别车辆信息',
  `house` varchar(255) default NULL COMMENT '房子信息',
...
-- 
-- 导出表中的数据 `app_member_credit`
-- 

INSERT INTO `app_member_credit` VALUES (2, 6, 123, '所属银行', '{"brand":"werwe","number":"werewr","model":"ertert","time":"2013-10-29"}', '{"site":"eqwe","area":"rwer"}', 'tryrty', 'rtyrt', 'yrtyrty1', 0);
INSERT INTO `app_member_credit` VALUES (4, 7, 12321323, 'rwer', '{"brand":"werwe","number":"werwer","model":"rew","time":"2013-10-29"}', '{"site":"sfdsd","area":"fsdf"}', 'sdfs', 'ffgdf', 'gdfg', 0);
INSERT INTO `app_member_credit` VALUES (5, 8, 132, 'sdfsdf', '{"brand":"fsdf","number":"","model":"sdfsdf","time":"2013-10-28"}', '{"site":"","area":""}', '', '', '', 0);
...
CREATE TABLE `app_member_life` (
  `id` int(10) NOT NULL auto_increment COMMENT '主键',
  `member_base_id` int(10) unsigned NOT NULL COMMENT '基本信息ID',
  `like_food` varchar(50) default NULL COMMENT '喜欢的食物',
  `not_like_food` varchar(50) default NULL COMMENT '不喜欢的食物',
  `hobby` varchar(50) default NULL COMMENT '爱好',
  `taste` varchar(255) default NULL COMMENT '口味',
  `like_broth` varchar(50) default NULL COMMENT '喜欢的汤品',
  `like_fruits` varchar(50) default NULL COMMENT '喜欢的水果',
  `like_drink` varchar(50) default NULL COMMENT '喜欢的饮品',
  `liek_flower` varchar(50) default NULL COMMENT '喜欢的鲜花',
  `like_liquor_brand` varchar(50) default NULL COMMENT '喜欢的酒类品牌',
  `like_color` varchar(50) default NULL COMMENT '喜欢的颜色',
  `exercise` varchar(50) default NULL COMMENT '是否有室内 运动的习惯',
  `other` text COMMENT '其他说明：',
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态：0正常-2删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='会员生活信息' AUTO_INCREMENT=7 ;

-- 
-- 导出表中的数据 `app_member_life`
-- 

INSERT INTO `app_member_life` VALUES (5, 10, '喜爱的食物', '忌口的食物', '个人爱好', '{"qd":"清淡","x":"咸","s":"酸","qt":"其他"}', '喜欢的汤品', '喜欢的水果', '喜欢的饮品', '喜欢的鲜花', '喜欢的酒类品牌', '喜欢的颜色', '是否有室内运动的习惯', '其他说明其他说明其他说明其他说明', 0);
INSERT INTO `app_member_life` VALUES (6, 6, '喜爱的食物', '忌口的食物', '个人爱好', '{"qd":"清淡","s":"酸","qt":"ad"}', '喜欢的汤品', '喜欢的水果', '喜欢的饮品', '喜欢的鲜花', '喜欢的酒类品牌', '喜欢的颜色', '是否有室内运动的习惯', '其他说明1', 0);
...
CREATE TABLE `app_member_photo` (
  ...
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态：0正常-2删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='会员照片' AUTO_INCREMENT=58 ;

-- 
-- 导出表中的数据 `app_member_photo`
-- 

INSERT INTO `app_member_photo` VALUES (39, 6, 3, '20131027/526d250e43ee1.png', 0);
INSERT INTO `app_member_photo` VALUES (38, 6, 3, '20131027/526d250e3b4b2.png', 0);
INSERT INTO `app_member_photo` VALUES (37, 6, 2, '20131027/526d24f6a65b9.png', 0);
INSERT INTO `app_member_photo` VALUES (36, 6, 2, '20131027/526d24f69dfba.png', 0);
INSERT INTO `app_member_photo` VALUES (35, 6, 2, '20131027/526d24f69578c.png', 0);
INSERT INTO `app_member_photo` VALUES (34, 6, 2, '20131027/526d24f68f566.png', 0);
INSERT INTO `app_member_photo` VALUES (33, 6, 1, '20131027/526d24e297715.jpg', 0);
INSERT INTO `app_member_photo` VALUES (32, 6, 1, '20131027/526d24e28f266.jpg', 0);
INSERT INTO `app_member_photo` VALUES (31, 6, 1, '20131027/526d24e288985.jpg', 0);
INSERT INTO `app_member_photo` VALUES (30, 6, 1, '20131027/526d24e27ff07.jpg', 0);
INSERT INTO `app_member_photo` VALUES (40, 6, 3, '20131027/526d250e4a531.png', 0);
INSERT INTO `app_member_photo` VALUES (41, 6, 4, '20131027/526d251ea16c9.png', 0);
INSERT INTO `app_member_photo` VALUES (42, 6, 4, '20131027/526d251ea9dab.jpg', 0);
INSERT INTO `app_member_photo` VALUES (43, 6, 4, '20131027/526d251eb28b3.png', 0);
INSERT INTO `app_member_photo` VALUES (44, 6, 5, '20131027/526d2527d0f3b.png', 0);
INSERT INTO `app_member_photo` VALUES (45, 6, 5, '20131027/526d2527d93be.png', 0);
INSERT INTO `app_member_photo` VALUES (46, 6, 5, '20131027/526d2527df94c.jpg', 0);
INSERT INTO `app_member_photo` VALUES (47, 6, 6, '20131027/526d2530c28ac.png', 0);
INSERT INTO `app_member_photo` VALUES (48, 6, 6, '20131027/526d2530cb3cf.jpg', 0);
INSERT INTO `app_member_photo` VALUES (49, 6, 6, '20131027/526d2530d41b3.png', 0);
INSERT INTO `app_member_photo` VALUES (51, 8, 2, '20131027/526d31723ceb8.jpg', 0);
INSERT INTO `app_member_photo` VALUES (52, 8, 2, '20131027/526d317246919.jpg', 0);
INSERT INTO `app_member_photo` VALUES (53, 8, 2, '20131027/526d317250073.jpg', 0);
INSERT INTO `app_member_photo` VALUES (54, 8, 2, '20131027/526d31725949f.jpg', 0);
INSERT INTO `app_member_photo` VALUES (55, 6, 1, '20131031/52713bd95cab5.png', -2);
INSERT INTO `app_member_photo` VALUES (56, 13, 2, '20131031/52713d010f6c6.jpg', -2);
INSERT INTO `app_member_photo` VALUES (57, 7, 1, '20131204/529ebc2e0ad07.jpg', 0);

-- --------------------------------------------------------

-- 
-- 表的结构 `app_member_rank`
-- 

CREATE TABLE `app_member_rank` (
  `id` smallint(5) unsigned NOT NULL auto_increment COMMENT '主键',
  `identifying` char(20) NOT NULL COMMENT '会员类型',
  `name` varchar(30) NOT NULL COMMENT '名称',
  `content` varchar(255) default NULL COMMENT '内容',
  `sort` smallint(5) unsigned NOT NULL default '0' COMMENT '排序',
  `is_start` tinyint(1) unsigned NOT NULL default '0' COMMENT '是否启用：0启用，1不启用',
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态：0正常，-2删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='会员级别表' AUTO_INCREMENT=51 ;

-- 
-- 导出表中的数据 `app_member_rank`
-- 

INSERT INTO `app_member_rank` VALUES (1, 'E', '5万级别会员', '车神白领俱乐部', 2, 0, 0);
INSERT INTO `app_member_rank` VALUES (2, 'D', '10万级别会员', '车神精英俱乐部', 3, 0, 0);
INSERT INTO `app_member_rank` VALUES (3, 'C', '20万级别会员', '车神总裁俱乐部', 4, 0, 0);
INSERT INTO `app_member_rank` VALUES (4, 'B', '40万级别会员', '车神贵族俱乐部', 5, 0, 0);
INSERT INTO `app_member_rank` VALUES (5, 'A', '80万级别会员', '车神领袖俱乐部', 6, 0, 0);
INSERT INTO `app_member_rank` VALUES (6, 'youxuan', '优选会员', '', 8, 1, 0);
INSERT INTO `app_member_rank` VALUES (7, 'linshi', '临时会员', '', 9, 1, 0);
INSERT INTO `app_member_rank` VALUES (8, 'shijia', '试驾会员', '', 10, 1, 0);
INSERT INTO `app_member_rank` VALUES (9, 'gudong', '股东会员', '车神贵族俱乐部', 7, 1, 0);
...
CREATE TABLE `app_member_resource` (
  `id` int(10) unsigned NOT NULL auto_increment COMMENT '主键',
  `resource_type` tinyint(2) unsigned NOT NULL COMMENT '资源类型(1车辆资源)',
  `resource_table` varchar(20) NOT NULL COMMENT '资源所属表',
  `member_rank_id` smallint(5) unsigned NOT NULL COMMENT '会员级别ID',
  `resource_id` smallint(5) NOT NULL COMMENT '资源ID',
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态0正常,-2删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='会员等级对应可用资源表' AUTO_INCREMENT=8 ;

-- 
-- 导出表中的数据 `app_member_resource`
-- 

INSERT INTO `app_member_resource` VALUES (1, 1, 'cars_grade', 1, 1, 0);
INSERT INTO `app_member_resource` VALUES (2, 1, 'cars_grade', 2, 2, 0);
INSERT INTO `app_member_resource` VALUES (3, 1, 'cars_grade', 3, 3, 0);
INSERT INTO `app_member_resource` VALUES (4, 1, 'cars_grade', 4, 4, 0);
INSERT INTO `app_member_resource` VALUES (5, 1, 'cars_grade', 5, 5, 0);
INSERT INTO `app_member_resource` VALUES (7, 1, 'cars_grade', 9, 4, 0);
...
CREATE TABLE `app_node` (
  ...
  KEY `level` (`level`),
  KEY `name` (`name`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='节点表(1项目、2模块、3方法)的关系' AUTO_INCREMENT=41 ;

-- 
-- 导出表中的数据 `app_node`
-- 

INSERT INTO `app_node` VALUES (1, 0, 'Admin', '车神OA系统', NULL, 0, 1, 0);
INSERT INTO `app_node` VALUES (2, 0, 'Home', '前台系统', NULL, 0, 1, 0);
INSERT INTO `app_node` VALUES (3, 0, 'Api', '接口系统', NULL, 0, 1, 0);
INSERT INTO `app_node` VALUES (4, 1, 'Rbac', '管理系统-权限控制模块', NULL, 0, 2, 0);
INSERT INTO `app_node` VALUES (5, 4, 'rbac_node', '管理系统-权限控制模块-节点管理', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (6, 4, 'node_edit', '管理系统-权限控制模块-编辑节点', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (7, 4, 'node_status', '管理系统-权限控制模块-节点状态管理', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (8, 4, 'group_node', '管理系统-权限控制模块-组与节点关系', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (9, 4, 'edit_group_node', '管理系统-权限控制模块-组与节点关系编辑', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (10, 4, 'group', '管理系统-权限控制模块-组管理', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (11, 4, 'groupEdit', '管理系统-权限控制模块-组编辑', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (12, 4, 'group_user', '管理系统-权限控制模块-分配组用户管理', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (13, 4, 'group_user_edit', '管理系统-权限控制模块-用户与组管理编', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (14, 1, 'Index', '管理系统-主页模块', NULL, 0, 2, 0);
INSERT INTO `app_node` VALUES (15, 14, 'index', '管理系统-主页模块-首页', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (16, 1, 'Login', '管理系统-登陆模块', NULL, 0, 2, 0);
INSERT INTO `app_node` VALUES (17, 16, 'login', '管理系统-登陆模块-登陆页面', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (18, 16, 'check_login', '管理系统-登陆模块-验证登陆', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (19, 16, 'logout', '管理系统-登陆模块-退出登陆', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (20, 1, 'Personnel', '管理系统-人事管理(部门管理模块)', NULL, 0, 2, 0);
INSERT INTO `app_node` VALUES (21, 20, 'department', '管理系统-部门管理-部门列表', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (22, 20, 'department_edit', '管理系统-部门管理-部门编辑', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (23, 20, 'occupation', '管理系统-部门管理-职位列表', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (24, 20, 'occupation_edit', '管理系统-部门管理-职位编辑', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (25, 1, 'Staff', '管理系统-人事管理(员工管理模块)', NULL, 0, 2, 0);
INSERT INTO `app_node` VALUES (26, 25, 'index', '管理系统-员工管理-员工列表', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (27, 25, 'staff_base_look', '管理系统-员工管理-基本信息查看', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (28, 25, 'staff_base_edit', '管理系统-员工管理-基本信息编辑', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (29, 25, 'staff_vitae_look', '管理系统-员工管理-履历信息查看', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (30, 25, 'staff_vitae_edit', '管理系统-员工管理-履历信息编辑', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (31, 25, 'staff_contract_look', '管理系统-员工管理-合同信息查看', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (32, 25, 'staff_contract_edit', '管理系统-员工管理-合同信息编辑', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (33, 25, 'staff_salary_look', '管理系统-员工管理-薪资信息查看', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (34, 25, 'staff_salary_edit', '管理系统-员工管理-薪资信息编辑', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (35, 25, 'staff_edit', '管理系统-员工管理-员工编辑页面', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (36, 1, 'CarsCompany', '分公司区域车辆管理', NULL, 0, 2, 0);
INSERT INTO `app_node` VALUES (37, 36, 'car_index', '车辆数据列表', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (38, 36, 'car_info', '车辆数据详细信息-及编辑', NULL, 0, 3, 0);
INSERT INTO `app_node` VALUES (39, 1, 'CarsAll', '公司所有区域车辆管理', NULL, 0, 2, 0);
INSERT INTO `app_node` VALUES (40, 39, 'index', '所有区域列表', NULL, 0, 3, 0);
...
CREATE TABLE `app_occupation` (
  ...
  `name` varchar(32) NOT NULL COMMENT '职位描述',
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='职位表' AUTO_INCREMENT=9 ;

-- 
-- 导出表中的数据 `app_occupation`
-- 

INSERT INTO `app_occupation` VALUES (8, 4, '司机', 0, '所有司机', 1385097204, 0);
...
CREATE TABLE `app_order` (
  ...
  `member_base_id` int(10) NOT NULL COMMENT '申请会员',
  `start` int(11) unsigned NOT NULL COMMENT '用车开始时间',
  `estimate_over` int(11) unsigned NOT NULL COMMENT '预计还车时间',
  `over` int(11) unsigned default NULL COMMENT '实际用车结束时间',
  `length` double(5,1) unsigned NOT NULL COMMENT '订单总用车时间,6小时算一天',
  `exceed_date` double(5,1) unsigned default NULL COMMENT '超过会员期用车天数，6小时算一天',
  `cars_id` smallint(6) NOT NULL COMMENT '申请车辆ID',
  `is_need_driver` tinyint(1) unsigned NOT NULL default '0' COMMENT '是否需要司机：0不需要1，1需要',
  `driver_id` int(10) unsigned default NULL COMMENT '司机ID',
  `remarks` varchar(30) default NULL COMMENT '备注',
  `auth_code` smallint(5) unsigned NOT NULL default '0' COMMENT '当前短信提车码',
  `order_state` tinyint(2) unsigned NOT NULL default '0' COMMENT '订单状态:0用车申请、1派车申请、2派车申请通过、3派车申请拒绝',
  `give_back_state` tinyint(1) unsigned NOT NULL default '0' COMMENT '车辆归还状态：0未归还，1已归还，2已归还但超时',
  `time` int(11) unsigned NOT NULL COMMENT '下单时间',
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态：0存在，-2删除',
  PRIMARY KEY  (`id`),
  KEY `order_num` (`order_num`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='用车申请订单表' AUTO_INCREMENT=11 ;

-- 
-- 导出表中的数据 `app_order`
-- 

INSERT INTO `app_order` VALUES (2, 'N2013112915040324774', 9, 1385869800, 1386827100, NULL, 0.0, NULL, 10001, 0, NULL, '', 0, 2, 0, 1385708643, 0);
INSERT INTO `app_order` VALUES (3, 'N2013112916080895047', 9, 1385826600, 1386298200, 1386376800, 7.0, 0.0, 10000, 0, NULL, '', 0, 2, 1, 1385712488, 0);
INSERT INTO `app_order` VALUES (4, 'N2013113023471015659', 9, 1385944800, 1386117600, 1386204000, 3.0, 0.0, 10001, 1, 14, '', 5185, 2, 1, 1385826430, 0);
INSERT INTO `app_order` VALUES (5, 'N2013120100023733169', 9, 1386028800, 1386115200, 1386115200, 1.0, 0.0, 10000, 0, NULL, '不需要司机', 5648, 2, 1, 1385827357, 0);
INSERT INTO `app_order` VALUES (6, 'N2013120100360995954', 11, 1386201600, 1386374400, 1386547200, 4.0, 0.0, 10001, 0, NULL, '不需要司机', 5343, 2, 1, 1385829369, 0);
INSERT INTO `app_order` VALUES (7, 'N2013120214220949367', 6, 1386129600, 1386216000, NULL, 0.0, NULL, 10004, 1, 14, '女司机', 2635, 2, 0, 1385965329, 0);
INSERT INTO `app_order` VALUES (8, 'N2013120214313666490', 6, 1386813600, 1387000800, 1387000800, 2.5, 0.0, 10004, 0, NULL, '', 3640, 2, 1, 1385965896, 0);
INSERT INTO `app_order` VALUES (9, 'N2013120413565149355', 6, 1387605300, 1388318100, NULL, 0.0, NULL, 10004, 1, 12, 'qweqweqeqqweqwe', 0, 2, 0, 1386136611, 0);
INSERT INTO `app_order` VALUES (10, 'N2013120417100171144', 6, 1386288000, 1386547200, 1386720900, 5.0, 0.0, 10004, 1, 0, '需要', 0, 2, 1, 1386148201, 0);

-- --------------------------------------------------------

-- 
-- 表的结构 `app_order_history`
-- 

CREATE TABLE `app_order_history` (
  `id` int(10) unsigned NOT NULL auto_increment COMMENT 'ID',
  `order_id` int(10) unsigned NOT NULL COMMENT '订单ID',
  `users_id` int(10) NOT NULL COMMENT '系统操作用户',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='订单操作历史记录' AUTO_INCREMENT=177 ;

-- 
-- 导出表中的数据 `app_order_history`
-- 

INSERT INTO `app_order_history` VALUES (88, 26, 1, '提交申请订单', 1384851102);
INSERT INTO `app_order_history` VALUES (89, 26, 1, '提交派车申请', 1384851121);
INSERT INTO `app_order_history` VALUES (90, 26, 1, '派车申请通过', 1384851168);
INSERT INTO `app_order_history` VALUES (91, 26, 1, '发送短信，状态为：成功。短信内容：[通过]，[提车码为:9833，请妥善保管] [提车地点为：上海]', 1384851202);
INSERT INTO `app_order_history` VALUES (92, 26, 1, '还车确认！', 1384851304);
INSERT INTO `app_order_history` VALUES (93, 27, 1, '提交申请订单', 1384925624);
INSERT INTO `app_order_history` VALUES (94, 28, 1, '提交申请订单', 1384925656);
INSERT INTO `app_order_history` VALUES (95, 29, 1, '提交申请订单', 1384934860);
INSERT INTO `app_order_history` VALUES (96, 30, 1, '提交申请订单', 1384934870);
INSERT INTO `app_order_history` VALUES (97, 31, 1, '提交申请订单', 1384934876);
INSERT INTO `app_order_history` VALUES (98, 31, 1, '提交派车申请', 1384934885);
INSERT INTO `app_order_history` VALUES (99, 29, 1, '提交派车申请', 1384934889);
INSERT INTO `app_order_history` VALUES (100, 30, 1, '提交派车申请', 1384934892);
INSERT INTO `app_order_history` VALUES (101, 31, 1, '派车申请通过', 1384934906);
INSERT INTO `app_order_history` VALUES (102, 28, 1, '提交派车申请', 1384939008);
INSERT INTO `app_order_history` VALUES (103, 30, 1, '派车申请拒绝', 1384939304);
INSERT INTO `app_order_history` VALUES (104, 31, 1, '还车确认！', 1384939327);
INSERT INTO `app_order_history` VALUES (105, 32, 1, '提交申请订单', 1385105562);
INSERT INTO `app_order_history` VALUES (106, 32, 1, '提交派车申请', 1385105575);
INSERT INTO `app_order_history` VALUES (107, 33, 1, '提交申请订单', 1385106418);
INSERT INTO `app_order_history` VALUES (108, 33, 1, '修改订单', 1385106908);
INSERT INTO `app_order_history` VALUES (109, 33, 1, '修改订单', 1385106968);
INSERT INTO `app_order_history` VALUES (110, 33, 1, '提交派车申请', 1385107435);
INSERT INTO `app_order_history` VALUES (111, 33, 1, '派车申请通过', 1385109161);
INSERT INTO `app_order_history` VALUES (112, 33, 1, '派车申请通过', 1385131851);
INSERT INTO `app_order_history` VALUES (113, 32, 1, '派车申请通过', 1385131874);
INSERT INTO `app_order_history` VALUES (114, 32, 1, '发送短信，状态为：失败。', 1385134155);
INSERT INTO `app_order_history` VALUES (115, 32, 1, '发送短信，状态为：失败。', 1385134166);
INSERT INTO `app_order_history` VALUES (116, 33, 1, '发送短信，状态为：成功。短信内容：ewr', 1385134434);
INSERT INTO `app_order_history` VALUES (117, 32, 1, '发送短信，状态为：失败。', 1385134456);
INSERT INTO `app_order_history` VALUES (118, 33, 1, '发送短信，状态为：成功。短信内容：456', 1385134476);
INSERT INTO `app_order_history` VALUES (119, 33, 1, '派车申请拒绝', 1385135469);
INSERT INTO `app_order_history` VALUES (120, 33, 1, '派车申请拒绝', 1385135567);
INSERT INTO `app_order_history` VALUES (121, 33, 1, '派车申请拒绝', 1385135769);
INSERT INTO `app_order_history` VALUES (122, 33, 1, '提交派车申请', 1385135814);
INSERT INTO `app_order_history` VALUES (123, 33, 1, '派车申请拒绝', 1385135847);
INSERT INTO `app_order_history` VALUES (124, 33, 1, '提交派车申请', 1385136055);
INSERT INTO `app_order_history` VALUES (125, 33, 1, '派车申请拒绝', 1385136065);
INSERT INTO `app_order_history` VALUES (126, 33, 1, '派车申请通过', 1385136123);
INSERT INTO `app_order_history` VALUES (127, 33, 1, '还车确认！', 1385137069);
INSERT INTO `app_order_history` VALUES (128, 33, 1, '还车确认！', 1385137154);
INSERT INTO `app_order_history` VALUES (129, 1, 1, '提交申请订单', 1385703770);
INSERT INTO `app_order_history` VALUES (130, 1, 1, '修改订单', 1385704011);
INSERT INTO `app_order_history` VALUES (131, 1, 1, '修改订单', 1385704067);
INSERT INTO `app_order_history` VALUES (132, 1, 1, '提交派车申请', 1385704291);
INSERT INTO `app_order_history` VALUES (133, 1, 1, '派车申请通过', 1385704595);
INSERT INTO `app_order_history` VALUES (134, 1, 1, '发送短信，状态为：成功。短信内容：您提交的订单审核结果为：[通过]，[提车码为:2760，请妥善保管] [提车地点为：XXXXXX]', 1385704611);
INSERT INTO `app_order_history` VALUES (135, 2, 1, '提交申请订单', 1385708643);
INSERT INTO `app_order_history` VALUES (136, 2, 1, '提交派车申请', 1385708656);
INSERT INTO `app_order_history` VALUES (137, 2, 1, '派车申请通过', 1385708698);
INSERT INTO `app_order_history` VALUES (138, 3, 1, '提交申请订单', 1385712488);
INSERT INTO `app_order_history` VALUES (139, 3, 1, '提交派车申请', 1385712650);
INSERT INTO `app_order_history` VALUES (140, 3, 1, '派车申请通过', 1385712909);
INSERT INTO `app_order_history` VALUES (141, 4, 1, '提交申请订单', 1385826430);
INSERT INTO `app_order_history` VALUES (142, 4, 1, '提交派车申请', 1385826441);
INSERT INTO `app_order_history` VALUES (143, 4, 1, '派车申请通过', 1385826468);
INSERT INTO `app_order_history` VALUES (144, 4, 1, '发送短信，状态为：成功。短信内容：尊敬的车神股东庚总您好，您的用车申请已经生成。请与按时取车', 1385826575);
INSERT INTO `app_order_history` VALUES (145, 4, 1, '还车确认！', 1385826599);
INSERT INTO `app_order_history` VALUES (146, 5, 1, '提交申请订单', 1385827357);
INSERT INTO `app_order_history` VALUES (147, 5, 1, '提交派车申请', 1385827372);
INSERT INTO `app_order_history` VALUES (148, 5, 1, '派车申请通过', 1385827394);
INSERT INTO `app_order_history` VALUES (149, 5, 1, '发送短信，状态为：成功。短信内容：尊敬的庚总，您好，您的用车申请已经生成，请您按时取车', 1385827448);
INSERT INTO `app_order_history` VALUES (150, 5, 1, '还车确认！', 1385827512);
INSERT INTO `app_order_history` VALUES (151, 6, 1, '提交申请订单', 1385829369);
INSERT INTO `app_order_history` VALUES (152, 6, 1, '提交派车申请', 1385829383);
INSERT INTO `app_order_history` VALUES (153, 6, 1, '派车申请通过', 1385829401);
INSERT INTO `app_order_history` VALUES (154, 6, 1, '发送短信，状态为：成功。短信内容：庚宇彬，提车码8984，请与12月8号8点在京基一百楼下取车，联系人王兆辉13828450426.', 1385829627);
INSERT INTO `app_order_history` VALUES (155, 6, 1, '还车确认！', 1385829661);
INSERT INTO `app_order_history` VALUES (156, 6, 1, '发送短信，状态为：成功。短信内容：庚宇彬，提车码（5343），于2013年12月1号10点京基A座提车，董国13828450426.', 1385837128);
INSERT INTO `app_order_history` VALUES (157, 7, 1, '提交申请订单', 1385965329);
INSERT INTO `app_order_history` VALUES (158, 7, 1, '提交派车申请', 1385965375);
INSERT INTO `app_order_history` VALUES (159, 7, 1, '派车申请通过', 1385965407);
INSERT INTO `app_order_history` VALUES (160, 7, 1, '发送短信，状态为：成功。短信内容：王兆辉，提车编码2635，请与2013年12月4号12点经', 1385965517);
INSERT INTO `app_order_history` VALUES (161, 3, 1, '还车确认！', 1385965665);
INSERT INTO `app_order_history` VALUES (162, 8, 1, '提交申请订单', 1385965896);
INSERT INTO `app_order_history` VALUES (163, 8, 1, '提交派车申请', 1385965906);
INSERT INTO `app_order_history` VALUES (164, 8, 1, '派车申请通过', 1385965915);
INSERT INTO `app_order_history` VALUES (165, 8, 1, '发送短信，状态为：成功。短信内容：您提交的订单审核结果为：[通过]，[提车码为:3640，请妥善保管] [提车地点为：123]', 1385965929);
INSERT INTO `app_order_history` VALUES (166, 8, 1, '还车确认！', 1385965966);
INSERT INTO `app_order_history` VALUES (167, 9, 1, '提交申请订单', 1386136611);
INSERT INTO `app_order_history` VALUES (168, 9, 1, '修改订单', 1386136623);
INSERT INTO `app_order_history` VALUES (169, 9, 1, '修改订单', 1386136632);
INSERT INTO `app_order_history` VALUES (170, 9, 1, '提交派车申请', 1386136647);
INSERT INTO `app_order_history` VALUES (171, 9, 1, '派车申请通过', 1386136742);
INSERT INTO `app_order_history` VALUES (172, 10, 1, '提交申请订单', 1386148201);
INSERT INTO `app_order_history` VALUES (173, 10, 1, '提交派车申请', 1386148216);
INSERT INTO `app_order_history` VALUES (174, 10, 1, '派车申请通过', 1386148268);
INSERT INTO `app_order_history` VALUES (175, 10, 1, '发送短信，状态为：失败。', 1386148304);
INSERT INTO `app_order_history` VALUES (176, 10, 1, '还车确认！', 1386148384);
...
CREATE TABLE `app_region` (
  ...
  `region_name` varchar(120) NOT NULL default '' COMMENT '区域名',
...
INSERT INTO `app_region` VALUES (38, 3, '巢湖', 2, 0);
...
INSERT INTO `app_region` VALUES (193, 13, '襄樊', 2, 0);
...
INSERT INTO `app_region` VALUES (416, 38, '居巢区', 3, 0);
INSERT INTO `app_region` VALUES (417, 38, '庐江县', 3, 0);
INSERT INTO `app_region` VALUES (418, 38, '无为县', 3, 0);
INSERT INTO `app_region` VALUES (419, 38, '含山县', 3, 0);
INSERT INTO `app_region` VALUES (420, 38, '和县', 3, 0);
...
INSERT INTO `app_region` VALUES (433, 41, '蚌山区', 3, 0);
INSERT INTO `app_region` VALUES (434, 41, '龙子湖区', 3, 0);
INSERT INTO `app_region` VALUES (435, 41, '禹会区', 3, 0);
INSERT INTO `app_region` VALUES (436, 41, '淮上区', 3, 0);
...
INSERT INTO `app_region` VALUES (444, 41, '颖上县', 3, 0);
...
INSERT INTO `app_region` VALUES (714, 79, '南城区', 3, 0);
INSERT INTO `app_region` VALUES (715, 79, '东城区', 3, 0);
INSERT INTO `app_region` VALUES (716, 79, '万江区', 3, 0);
INSERT INTO `app_region` VALUES (717, 79, '莞城区', 3, 0);
INSERT INTO `app_region` VALUES (718, 79, '石龙镇', 3, 0);
INSERT INTO `app_region` VALUES (719, 79, '虎门镇', 3, 0);
INSERT INTO `app_region` VALUES (720, 79, '麻涌镇', 3, 0);
INSERT INTO `app_region` VALUES (721, 79, '道滘镇', 3, 0);
INSERT INTO `app_region` VALUES (722, 79, '石碣镇', 3, 0);
INSERT INTO `app_region` VALUES (723, 79, '沙田镇', 3, 0);
INSERT INTO `app_region` VALUES (724, 79, '望牛墩镇', 3, 0);
INSERT INTO `app_region` VALUES (725, 79, '洪梅镇', 3, 0);
INSERT INTO `app_region` VALUES (726, 79, '茶山镇', 3, 0);
INSERT INTO `app_region` VALUES (727, 79, '寮步镇', 3, 0);
INSERT INTO `app_region` VALUES (728, 79, '大岭山镇', 3, 0);
INSERT INTO `app_region` VALUES (729, 79, '大朗镇', 3, 0);
INSERT INTO `app_region` VALUES (730, 79, '黄江镇', 3, 0);
INSERT INTO `app_region` VALUES (731, 79, '樟木头', 3, 0);
INSERT INTO `app_region` VALUES (732, 79, '凤岗镇', 3, 0);
INSERT INTO `app_region` VALUES (733, 79, '塘厦镇', 3, 0);
INSERT INTO `app_region` VALUES (734, 79, '谢岗镇', 3, 0);
INSERT INTO `app_region` VALUES (735, 79, '厚街镇', 3, 0);
INSERT INTO `app_region` VALUES (736, 79, '清溪镇', 3, 0);
INSERT INTO `app_region` VALUES (737, 79, '常平镇', 3, 0);
INSERT INTO `app_region` VALUES (738, 79, '桥头镇', 3, 0);
INSERT INTO `app_region` VALUES (739, 79, '横沥镇', 3, 0);
INSERT INTO `app_region` VALUES (740, 79, '东坑镇', 3, 0);
INSERT INTO `app_region` VALUES (741, 79, '企石镇', 3, 0);
INSERT INTO `app_region` VALUES (742, 79, '石排镇', 3, 0);
INSERT INTO `app_region` VALUES (743, 79, '长安镇', 3, 0);
INSERT INTO `app_region` VALUES (744, 79, '中堂镇', 3, 0);
INSERT INTO `app_region` VALUES (745, 79, '高埗镇', 3, 0);
...
INSERT INTO `app_region` VALUES (1154, 142, '从台区', 3, 0);
...
INSERT INTO `app_region` VALUES (1495, 176, '铁峰区', 3, 0);
...
INSERT INTO `app_region` VALUES (1904, 226, '经济开发区', 3, 0);
...
INSERT INTO `app_region` VALUES (2042, 240, '波阳县', 3, 0);
...
INSERT INTO `app_region` VALUES (2867, 336, '东  区', 3, 0);
INSERT INTO `app_region` VALUES (2868, 336, '西  区', 3, 0);
...
INSERT INTO `app_region` VALUES (3076, 366, '阿勒泰市', 3, 0);
...
INSERT INTO `app_region` VALUES (3081, 366, '乌苏市', 3, 0);
INSERT INTO `app_region` VALUES (3082, 366, '额敏县', 3, 0);
INSERT INTO `app_region` VALUES (3083, 366, '富蕴县', 3, 0);
INSERT INTO `app_region` VALUES (3084, 366, '伊宁县', 3, 0);
INSERT INTO `app_region` VALUES (3085, 366, '福海县', 3, 0);
INSERT INTO `app_region` VALUES (3086, 366, '霍城县', 3, 0);
INSERT INTO `app_region` VALUES (3087, 366, '沙湾县', 3, 0);
INSERT INTO `app_region` VALUES (3088, 366, '巩留县', 3, 0);
INSERT INTO `app_region` VALUES (3089, 366, '哈巴河县', 3, 0);
INSERT INTO `app_region` VALUES (3090, 366, '托里县', 3, 0);
INSERT INTO `app_region` VALUES (3091, 366, '青河县', 3, 0);
INSERT INTO `app_region` VALUES (3092, 366, '新源县', 3, 0);
INSERT INTO `app_region` VALUES (3093, 366, '裕民县', 3, 0);
INSERT INTO `app_region` VALUES (3094, 366, '和布克赛尔', 3, 0);
...
INSERT INTO `app_region` VALUES (3320, 393, '衢州市', 3, 0);
...
-- 
-- 表的结构 `app_reserve_talents`
-- 

CREATE TABLE `app_reserve_talents` (
  `id` int(10) unsigned NOT NULL auto_increment COMMENT '主键',
  `jobs` varchar(20) NOT NULL COMMENT '应聘岗位',
  `name` varchar(20) NOT NULL COMMENT '员工姓名',
  `name_en` varchar(20) default NULL COMMENT '英文名称',
  `ethnic` varchar(10) default NULL COMMENT '名族',
  `identity` varchar(18) NOT NULL COMMENT '身份号码',
  `identity_address` varchar(255) NOT NULL COMMENT '身份证件地址',
  `dwell_address` varchar(255) default NULL COMMENT '居住地址',
  ...
  `ancestral` varchar(20) default NULL COMMENT '祖籍',
  ...
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态：0正常，-2删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='人才储备' AUTO_INCREMENT=3 ;

-- 
-- 导出表中的数据 `app_reserve_talents`
-- 

INSERT INTO `app_reserve_talents` VALUES (1, '岗位1', '姓名1', '姓名EN1', '汉族', '12346578979898798', '身份证地址', '身份证住址', '男', '1', '1.75', '2013-11-06', '25', '学历', NULL, NULL, NULL, NULL, '123456789123', NULL, 0);
INSERT INTO `app_reserve_talents` VALUES (2, '应聘岗位', '姓名', '英文姓名', '民族', '342401199201208174', '身份证地址', '居住地址', '女', '血型', '身高', '1992-01-20', '年龄', '学历', '专业', '祖籍', '政治面貌', 'ucdchinalin@gmail.co', '电话号码', '备注', 0);

-- --------------------------------------------------------

-- 
-- 表的结构 `app_staff_achievements`
-- 

CREATE TABLE `app_staff_achievements` (
  `id` smallint(6) unsigned NOT NULL auto_increment COMMENT '主键',
  `base_id` int(10) unsigned NOT NULL COMMENT '基本信息id',
  `users_id` int(10) unsigned NOT NULL COMMENT '操作人',
  `month_pay` decimal(9,2) default NULL COMMENT '月薪资',
  `achievements_pay` decimal(9,2) default NULL COMMENT '绩效奖金',
  `issue_time` date default NULL COMMENT '发放日期',
  `result` varchar(255) default NULL COMMENT '考核结果',
  `remarks` varchar(255) default NULL COMMENT '备注',
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态：0正常，-2删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='工资政绩表' AUTO_INCREMENT=5 ;

-- 
-- 导出表中的数据 `app_staff_achievements`
-- 

INSERT INTO `app_staff_achievements` VALUES (1, 5, 1, 12.00, 123.00, '2013-11-13', '123', '123', 0);
INSERT INTO `app_staff_achievements` VALUES (2, 5, 1, 4561.00, 1232.00, '2013-11-29', '考核结果2', '备注3', 0);
...
CREATE TABLE `app_staff_alteration` (
  `id` smallint(6) unsigned NOT NULL auto_increment COMMENT '主键',
  `base_id` int(10) NOT NULL COMMENT '基本信息id',
  `data_time` varchar(20) default NULL COMMENT '日期',
  `incident` varchar(255) default NULL COMMENT '事件',
...
-- 
-- 导出表中的数据 `app_staff_alteration`
-- 

INSERT INTO `app_staff_alteration` VALUES (1, 6, '2013-10-20', '12345', 100.00, 0);
...
CREATE TABLE `app_staff_base` (
  ...
  `politics` varchar(10) default NULL COMMENT '政治面貌',
  `email` varchar(20) default NULL COMMENT '电子邮箱',
  `social_num` varchar(20) default NULL COMMENT '社保电脑号',
  `phone` varchar(15) default NULL COMMENT '电话号码',
  `contact_person` varchar(20) default NULL COMMENT '紧急联络人',
  `contact_phone` varchar(20) default NULL COMMENT '紧急联络人电话',
  ...
  `remarks` text COMMENT '备注',
  `driver_status` tinyint(1) unsigned NOT NULL default '0' COMMENT '司机状态：0正常，1出车',
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态：0正常，-2删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='员工基本信息表' AUTO_INCREMENT=16 ;

-- 
-- 导出表中的数据 `app_staff_base`
-- 

INSERT INTO `app_staff_base` VALUES (14, 10014, '司机', '司机1', 'EQWE', 1, 4, 8, '', '12345678978945646', '', '', '女', '', '', '已婚', '0000-00-00', '', '', '', '', '', '', '13761951734', '', '', '', '', NULL, NULL, 0, '', 1, 0);
INSERT INTO `app_staff_base` VALUES (13, 10013, '司机', '司机3', 'EQWE', 1, 4, 8, '', '12345678978945646', '', '', '男', '', '', '已婚', '0000-00-00', '', '', '', '', '', '', '13761951734', '', '', '', '', NULL, NULL, 0, '', 1, 0);
INSERT INTO `app_staff_base` VALUES (12, 10012, '司机', '司机2', '123123', 1, 4, 8, '', '12345678978945646', '', '', '男', '', '', '已婚', '0000-00-00', '', '', '', '', '', '', '13761951734', '', '', '', '', NULL, NULL, 0, '', 1, 0);
INSERT INTO `app_staff_base` VALUES (1, 1001, '管理员', '管理员', 'admin', 1, 0, 0, NULL, '', '', NULL, '', NULL, NULL, '', '0000-00-00', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0, -2);
...
CREATE TABLE `app_staff_contract` (
  `id` smallint(6) unsigned NOT NULL auto_increment COMMENT '主键',
  `base_id` int(10) unsigned NOT NULL COMMENT '基本信息id',
  `entry_time` varchar(20) default NULL COMMENT '入职日期',
  `official_time` varchar(20) default NULL COMMENT '转正日期',
  `dimission_time` varchar(20) default NULL COMMENT '离职日期',
  `contract_start` varchar(20) default NULL COMMENT '合同起始日期',
  `contract_over` varchar(20) default NULL COMMENT '合同结束日期',
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态:0正常，-2删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='员工合同信息' AUTO_INCREMENT=2 ;

-- 
-- 导出表中的数据 `app_staff_contract`
-- 
...
CREATE TABLE `app_staff_education` (
  `id` smallint(6) unsigned NOT NULL auto_increment COMMENT '主键',
  `base_id` int(10) unsigned NOT NULL COMMENT '基本表id',
  `school` varchar(50) default NULL COMMENT '毕业学校',
  `major` varchar(50) default NULL COMMENT '专业-主修',
  `data_time` varchar(50) default NULL COMMENT '起止日期',
  `certificate` varchar(50) default NULL COMMENT '证书',
  `witness` varchar(50) default NULL COMMENT '证明人以及电话',
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态：0正常，-2删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='员工教育经历表' AUTO_INCREMENT=4 ;

-- 
-- 导出表中的数据 `app_staff_education`
-- 
...
CREATE TABLE `app_staff_salary` (
  `id` smallint(6) unsigned NOT NULL auto_increment COMMENT '主键',
  `base_id` int(10) unsigned NOT NULL COMMENT '基本信息id',
  `open_bank` varchar(30) NOT NULL COMMENT '开户银行',
  `open_account` varchar(50) NOT NULL COMMENT '银行账号',
  `start_time` varchar(20) NOT NULL COMMENT '起始日期',
  `stop_time` varchar(15) NOT NULL COMMENT '终止日期',
  `pay` decimal(9,2) NOT NULL COMMENT '工资',
  `remarks` varchar(255) default NULL COMMENT '备注',
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态：0正常，-2删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='工资信息表' AUTO_INCREMENT=3 ;

-- 
-- 导出表中的数据 `app_staff_salary`
-- 
...
CREATE TABLE `app_staff_work` (
  `id` smallint(5) unsigned NOT NULL auto_increment COMMENT '主键',
  `base_id` int(10) unsigned NOT NULL COMMENT '基本信息id',
  `company` varchar(50) default NULL COMMENT '公司',
  `data_time` varchar(50) default NULL COMMENT '起止日期',
  `position` varchar(50) default NULL COMMENT '职位',
  `responsibility` varchar(50) default NULL COMMENT '职责',
  `salary` varchar(20) default NULL COMMENT '工资',
  `dimission` varchar(50) NOT NULL COMMENT '离职原因',
...
CREATE TABLE `app_users` (
  ...
  UNIQUE KEY `id` (`id`),
  UNIQUE KEY `account` (`account`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='员工账号表' AUTO_INCREMENT=9 ;

-- 
-- 导出表中的数据 `app_users`
-- 

INSERT INTO `app_users` VALUES (1, 1, 'admin', '管理员', 'e10adc3949ba59abbe56e057f20f883e', 1386308393, '58.60.48.231', 250, 1376561926, 1376561926, 0, 0);
INSERT INTO `app_users` VALUES (2, 5, 'zhuguan', 'wade', 'e10adc3949ba59abbe56e057f20f883e', 1384331854, '192.168.1.102', 37, 1377506459, 1377506459, 1, 0);
INSERT INTO `app_users` VALUES (3, 6, 'siyou', '', 'e10adc3949ba59abbe56e057f20f883e', 1382111825, '192.168.1.100', 13, 1377590474, 1377590474, 1, 0);
INSERT INTO `app_users` VALUES (5, 7, 'jiben', '', 'e10adc3949ba59abbe56e057f20f883e', 1383021894, '192.168.1.102', 8, 1377847312, 1377847312, 1, 0);
INSERT INTO `app_users` VALUES (6, 10, '10010', NULL, 'e10adc3949ba59abbe56e057f20f883e', 1382113799, '192.168.1.100', 1, 1382113600, 1382113600, 1, 0);
INSERT INTO `app_users` VALUES (7, 11, '10011', NULL, 'e10adc3949ba59abbe56e057f20f883e', 1385097808, '192.168.1.102', 0, 1385097808, 1385097808, 1, 1);
INSERT INTO `app_users` VALUES (8, 12, '10012', NULL, 'e10adc3949ba59abbe56e057f20f883e', 1385099614, '192.168.1.102', 0, 1385099614, 1385099614, 1, 1);
