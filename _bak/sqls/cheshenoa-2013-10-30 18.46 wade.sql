...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='会员卡片记录' AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `app_cars` (
  ...
  `grade` char(10) NOT NULL COMMENT '车辆级别',
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '状态：0正常，-2删除',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='车辆信息表' AUTO_INCREMENT=10004 ;

--
-- 转存表中的数据 `app_cars`
--

INSERT INTO `app_cars` (`id`, `company_id`, `grade`, `brand`, `car_num`, `type`, `color`, `master`, `buy_data`, `buy_num`, `buy_cost`, `initial_km`, `department`, `engine_num`, `frame_num`, `seat_num`, `year_audit_date`, `year_audit_item`, `year_audit_state`, `year_audit_next`, `insurance_start_date`, `insurance_company`, `insurance_state`, `insurance_item`, `insurance_stop`, `remarks`, `car_status`, `status`) VALUES
(10000, 1, '200', '玛莎拉蒂', '车牌号码', '车辆类型', '车辆颜色', '车辆所有人', '2013-10-02', 2, 2, '初始公里数', '所属部门', '发动机号', '车架号', 0, '2013-10-31', '年审项目', '年审情况', '2013-10-29', '2013-10-09', '保险公司', '投保情况', '投保项目', '2013-10-31', 'aa', 2, 0),
(10001, 1, '50', '兰博基尼', '车牌号码*', '车辆类型', '车辆颜色*', '车辆所有人', '2013-10-09', 12, 10, '初始公里数', '所属部门', '发动机号', '车架号', 4, '2013-10-02', '年审项目', '年审情况', '2013-10-07', '2013-10-03', '保险公司', '投保情况', '投保项目', '2013-10-22', 'ada', 0, 0),
(10003, 1, '200', '车辆品牌', '车牌号码', '车辆类型', '车辆颜色', '车辆所有人', '2013-10-10', 2, 123, '初始公里数', '所属部门', '发动机号', '车架号', 92, '2013-10-29', '年审项目', '年审情况', '2013-10-29', '2013-10-29', ' 保险公司：', '投保情况', '投保项目', '2013-10-22', 'asdasda', 2, 0);
...
CREATE TABLE IF NOT EXISTS `app_cars_grade` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '状态：0正常，-2删除',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='车辆产品表' AUTO_INCREMENT=6 ;
...
CREATE TABLE IF NOT EXISTS `app_cars_photo` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '状态：0正常-2删除',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='车辆照片' AUTO_INCREMENT=7 ;
...
CREATE TABLE IF NOT EXISTS `app_member_base` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='会员基本资料' AUTO_INCREMENT=13 ;
...
(6, 3, 'qweqwe', 3, 'qweqw', 'weqwe', '男', '11111111111', 'asdasd', '234234', '498798', 'E', '456456465465465', '', '56456', 'sdfsfsfsdf', '', '', '股份公司,个人经营,有限公司', '0', '', '', '0', '', '', '', '', '', '', '', '', '', '', '', '', 0, 0),
(7, 1, 'sdfsdf', 2, 'sdfdsf', 'sdfsdfsdf', '男', '12312312313', '12312312', '12321321', '213123', 'D', '235659456456456456', '', '45646', '45645', '', '', '股份公司,有限公司,有限责任公司', '0', '', '', '0', '', '', NULL, '', '', '', NULL, '', '', '', '', '', 0, 0),
(8, 1, 'sdfsdf', 2, 'sdfdsf', 'sdfsdfsdf', '男', '12312312313', '12312312', '12321321', '213123', 'C', '235659456456456456', '', '45646', '45645', '', '', '股份公司,有限公司,有限责任公司', '0', '', '', '0', '', '', NULL, '', '', '', NULL, '', '', '', '', '', 0, 0),
(9, 2, '投资区域', 3, '自主', '会员姓名', '女', '11111111111', '123456', '234234', '498798', 'B', '456456465465465', 'qweqweqw', '123123123123', 'qweqw', 'aa@qq.com', '企业名称', '股份公司,有限公司,有限责任公司', '100000000', '法人', '会员组成成员', '200000000', 'http://www.baidu.com', '通讯地址', '企业所处行业位置', '个人介绍及社会身份', '企业主要合作方', '主要经营产品', '产品产地分布', '市场占有率', '业务发展规划', '紧急联系人', '关 系', '手机号码', 0, 0),
(10, 2, 'ada', 2, 'adasd', 'sdfsdf', '女', '11111111111', 'asdasd', '234234', '123123123123', 'A', '456456465465465', 'qweqweqw', '123123123123', 'qweqw', 'asd252392785@163.com', '', '个人经营,有限责任公司', '100', 'sdfsd', 'sdfs', '200', 'http://www.baidu.com', 'gdfg', 'dgdf', '个人介绍及社会身份', '企业主要合作方', '主要经营产品', '产品产地分布', '市场占有率', '业务发展规划', '紧急联系人', ' 系', '手机号码', 1, 0),
(11, 1, 'aaaa', 3, 'bbbb', '123', '男', '12312312313', '12312312', '12321321', '213123', 'shijia', '235659456456456456', '4', '45646', '45645', '', '', NULL, '0', '', '', '0', '', '', '', '', '', '', '', '', '', '', '', '', 0, 0),
(12, 1, 'sfsdf', 2, 'sfsdf', '123456', '女', '12345678991', '123123', '123123123', '49456564', 'gudong', '456456465465465', 'fghfghf', '123123123123', 'qweqw', '', '', NULL, '0', '', '', '0', '', '', '', '', '', '', '', '', '', '', '', '', 1, 0);
...
CREATE TABLE IF NOT EXISTS `app_member_photo` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '状态：0正常-2删除',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='会员照片' AUTO_INCREMENT=55 ;
...
CREATE TABLE IF NOT EXISTS `app_member_rank` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '状态：0正常，-2删除',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='会员级别表' AUTO_INCREMENT=10 ;

--
-- 转存表中的数据 `app_member_rank`
--

INSERT INTO `app_member_rank` (`id`, `identifying`, `name`, `content`, `sort`, `status`) VALUES
(1, 'E', '5万级别会员', '车神白领俱乐部', 1, 0),
(2, 'D', '10万级别会员', '车神精英俱乐部', 2, 0),
(3, 'C', '20万级别会员', '车神总裁俱乐部', 3, 0),
(4, 'B', '40万级别会员', '车神贵族俱乐部', 4, 0),
(5, 'A', '80万级别会员', '车神领袖俱乐部', 5, 0),
(6, 'youxuan', '优选会员', '', 7, 0),
(7, 'linshi', '临时会员', '', 8, 0),
(8, 'shijia', '试驾会员', '', 9, 0),
(9, 'gudong', '股东会员(40万级别)', '', 6, 0);
...
(1, 1, 'admin', '管理员', 'e10adc3949ba59abbe56e057f20f883e', 1383110652, '192.168.1.102', 188, 1376561926, 1376561926, 0, 0),
