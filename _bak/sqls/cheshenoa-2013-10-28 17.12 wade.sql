...
CREATE TABLE IF NOT EXISTS `app_cars` (
  ...
  `rank` char(10) NOT NULL COMMENT '车辆级别',
  `car_num` char(20) DEFAULT NULL COMMENT '车牌号码',
  `type` char(20) NOT NULL COMMENT '车辆类型',
  `color` char(10) NOT NULL COMMENT '车辆颜色',
  `master` char(20) NOT NULL COMMENT '车辆主人',
  ...
  `initial_km` char(10) NOT NULL COMMENT '初始公里数',
  ...
  `seat_num` char(5) NOT NULL COMMENT '座位数',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='车辆信息表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `app_group_node` (
  ...
  KEY `nodeId` (`node_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='组与节点关系表' AUTO_INCREMENT=145 ;
...
(1, 1, 'admin', '管理员', 'e10adc3949ba59abbe56e057f20f883e', 1382950733, '192.168.1.102', 183, 1376561926, 1376561926, 0, 0),
(2, 5, 'zhuguan', 'wade', 'e10adc3949ba59abbe56e057f20f883e', 1382951143, '192.168.1.102', 33, 1377506459, 1377506459, 1, 0),
