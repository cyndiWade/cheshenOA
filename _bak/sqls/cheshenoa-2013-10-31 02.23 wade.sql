...
CREATE TABLE IF NOT EXISTS `app_cars` (
  ...
  `department` char(30) NOT NULL COMMENT '所属部门(与系统部门无关系)',
  `engine_num` char(30) NOT NULL COMMENT '发动机型号',
  `frame_num` char(30) NOT NULL COMMENT '车架号',
  `seat_num` tinyint(2) unsigned NOT NULL COMMENT '座位数',
  `year_audit_date` date DEFAULT NULL COMMENT '年审日期',
  `year_audit_item` char(30) DEFAULT NULL COMMENT '年审项目',
  `year_audit_state` char(30) DEFAULT NULL COMMENT '年审状况',
  `year_audit_next` date DEFAULT NULL COMMENT '下次年审日期',
  `insurance_start_date` date DEFAULT NULL COMMENT '入保时间',
  `insurance_company` char(30) DEFAULT NULL COMMENT '保险公司',
  `insurance_state` char(30) DEFAULT NULL COMMENT '投保情况',
  `insurance_item` char(30) DEFAULT NULL COMMENT '投保项目',
...
CREATE TABLE IF NOT EXISTS `app_member_base` (
  ...
  `source_content` char(32) NOT NULL COMMENT '来源内容',
...
(6, 3, 1, 'qweqwe', 3, 'qweqw', 'weqwe', '男', '11111111111', 'asdasd', '234234', '498798', '456456465465465', '', '56456', 'sdfsfsfsdf', '', '', '股份公司,个人经营,有限公司', '0', '', '', '0', '', '', '', '', '', '', '', '', '', '', '', '', '0000-00-00', 0),
...
CREATE TABLE IF NOT EXISTS `app_member_resource` (
  ...
  `resource_table` char(20) NOT NULL COMMENT '资源所属表',
...
(1, 1, 'admin', '管理员', 'e10adc3949ba59abbe56e057f20f883e', 1383139206, '192.168.1.100', 189, 1376561926, 1376561926, 0, 0),
