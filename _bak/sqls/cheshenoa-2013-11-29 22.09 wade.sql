...
CREATE TABLE `app_cars` (
  ...
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态：0正常，-2删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='车辆信息表' AUTO_INCREMENT=10006 ;

-- 
-- 导出表中的数据 `app_cars`
-- 

INSERT INTO `app_cars` VALUES (10000, 1, 4, '玛莎拉蒂', '粤GA9900', '总裁', '白色', '车辆所有人', '2013-10-02', 2, 2, '初始公里数', '所属部门', '发动机号', '车架号', 0, 'kkk', 3, 0);
INSERT INTO `app_cars` VALUES (10001, 1, 4, '兰博基尼', '粤GA9901', '盖拉多', '黑色', '车辆所有人', '2013-10-09', 12, 10, '初始公里数', '所属部门', '发动机号', '车架号', 4, 'ada', 3, 0);
...
INSERT INTO `app_cars_photo` VALUES (1, 10000, 1, '20131029/526f7f71ec42b.jpg', 0);
...
CREATE TABLE `app_cars_schedule` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='车辆日程安排表' AUTO_INCREMENT=7 ;
...
INSERT INTO `app_member_base` VALUES (6, 3, 1, 'qweqwe', 3, 'qweqw', '康熙来了', '男', '11111111111', 'asdasd', '234234', '498798', '456456465465465', '', '56456', 'sdfsfsfsdf', 5, '', '', '股份公司,个人经营,有限公司', 0, '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '2013-11-05', '2014-11-05', 0.0, 0);
...
INSERT INTO `app_member_base` VALUES (11, 1, 9, 'aaaa', 3, 'bbbb', '123', '男', '13761951734', '12312312', '12321321', '213123', '235659456456456456', '4', '45646', '45645', 5, '', '', NULL, 0, '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '2013-11-05', '2014-11-05', 0.0, 0);
...
INSERT INTO `app_member_base` VALUES (15, 1, 9, '投资区域', 3, 'SDFSDF', 'qeww', '男', '12312312313', '12312312', '12321321', '213123', '235659456456456456', '', '45646', '45645', 4, '', '', NULL, 0, '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '2013-11-05', '2014-11-05', 0.0, 0);
INSERT INTO `app_member_base` VALUES (16, 1, 9, 'adasd', 2, 'aaa', 'qweqwe', '男', '12312312313', '12312312', '12321321', '213123', '235659456456456456', '', '45646', '45645', 1, '', '', NULL, 0, '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '2013-10-30', '2014-11-05', 0.0, 0);
...
CREATE TABLE `app_member_photo` (
  ...
  `status` tinyint(1) NOT NULL default '0' COMMENT '状态：0正常-2删除',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='会员照片' AUTO_INCREMENT=57 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='用车申请订单表' AUTO_INCREMENT=4 ;
...
INSERT INTO `app_order` VALUES (3, 'N2013112916080895047', 9, 1385826600, 1386298200, NULL, 0.0, NULL, 10000, 0, NULL, '', 0, 2, 0, 1385712488, 0);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='订单操作历史记录' AUTO_INCREMENT=141 ;
...
INSERT INTO `app_staff_base` VALUES (14, 10014, '司机', '司机1', 'EQWE', 1, 4, 8, '', '12345678978945646', '', '', '女', '', '', '已婚', '0000-00-00', '', '', '', '', '', '', '13761951734', '', '', '', '', NULL, NULL, 0, '', 0, 0);
...
INSERT INTO `app_staff_base` VALUES (12, 10012, '司机', '司机2', '123123', 1, 4, 8, '', '12345678978945646', '', '', '男', '', '', '已婚', '0000-00-00', '', '', '', '', '', '', '13761951734', '', '', '', '', NULL, NULL, 0, '', 0, 0);
INSERT INTO `app_staff_base` VALUES (1, 1001, '管理员', '管理员', 'admin', 1, 0, 0, NULL, '', '', NULL, '', NULL, NULL, '', '0000-00-00', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0, 0);
...
INSERT INTO `app_users` VALUES (1, 1, 'admin', '管理员', 'e10adc3949ba59abbe56e057f20f883e', 1385727620, '58.60.50.83', 224, 1376561926, 1376561926, 0, 0);
