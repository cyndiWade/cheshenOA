...
CREATE TABLE IF NOT EXISTS `app_cars` (
  ...
  `year_audit_date` date DEFAULT NULL COMMENT '年审日期',
  `year_audit_item` varchar(30) DEFAULT NULL COMMENT '年审项目',
  `year_audit_state` varchar(10) DEFAULT NULL COMMENT '年审状况',
  `year_audit_next` date DEFAULT NULL COMMENT '下次年审日期',
  `insurance_start_date` date DEFAULT NULL COMMENT '入保时间',
  `insurance_company` varchar(30) DEFAULT NULL COMMENT '保险公司',
  `insurance_state` varchar(30) DEFAULT NULL COMMENT '投保情况',
  `insurance_item` varchar(30) DEFAULT NULL COMMENT '投保项目',
  `insurance_stop` date DEFAULT NULL COMMENT '出保日期',
  `remarks` text COMMENT '备注',
  `car_status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '车辆状况(0123，依次类推)：正常、维修中、报废、租用中',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '状态：0正常，-2删除',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='车辆信息表' AUTO_INCREMENT=10005 ;

--
-- 转存表中的数据 `app_cars`
--

INSERT INTO `app_cars` (`id`, `company_id`, `cars_grade_id`, `brand`, `car_num`, `type`, `color`, `master`, `buy_data`, `buy_num`, `buy_cost`, `initial_km`, `department`, `engine_num`, `frame_num`, `seat_num`, `year_audit_date`, `year_audit_item`, `year_audit_state`, `year_audit_next`, `insurance_start_date`, `insurance_company`, `insurance_state`, `insurance_item`, `insurance_stop`, `remarks`, `car_status`, `status`) VALUES
(10000, 1, 3, '玛莎拉蒂', '车牌号码', '车辆类型', '车辆颜色', '车辆所有人', '2013-10-02', 2, 2, '初始公里数', '所属部门', '发动机号', '车架号', 0, '2013-10-31', '年审项目', '年审情况', '2013-10-29', '2013-10-09', '保险公司', '投保情况', '投保项目', '2013-10-31', 'aa', 2, 0),
(10001, 1, 2, '兰博基尼', '车牌号码*', '车辆类型', '车辆颜色*', '车辆所有人', '2013-10-09', 12, 10, '初始公里数', '所属部门', '发动机号', '车架号', 4, '2013-10-02', '年审项目', '年审情况', '2013-10-07', '2013-10-03', '保险公司', '投保情况', '投保项目', '2013-10-22', 'ada', 0, 0),
(10003, 1, 1, '车辆品牌', '车牌号码', '车辆类型', '车辆颜色', '车辆所有人', '2013-10-10', 2, 123, '初始公里数', '所属部门', '发动机号', '车架号', 92, '2013-10-29', '年审项目', '年审情况', '2013-10-29', '2013-10-29', ' 保险公司：', '投保情况', '投保项目', '2013-10-22', 'asdasda', 2, 0),
(10004, 1, 5, '劳斯莱斯', '车牌号码', '车辆类型', '车辆颜色', '车辆所有人', '2013-10-29', 2, 2, '初始公里数', '所属部门', '发动机号', '车架号', 2, '2013-10-01', '年审项目', '年审情况', '2013-10-08', '2013-10-29', '保险公司', '投保情况', '投保项目', '2013-10-21', '备注', 0, 0);
...
INSERT INTO `app_cars_grade` (`id`, `identifying`, `name`, `content`, `status`) VALUES
(1, '50', '50万级别豪车', '', 0),
(2, '100', '100万级别豪车', '', 0),
(3, '200', '200万级别豪车', '', 0),
(4, '400', '400万级别豪车', '', 0),
...
INSERT INTO `app_member_base` (`id`, `member_id`, `member_rank_id`, `area`, `source`, `source_content`, `name`, `sex`, `mobile_phone`, `phone`, `fax`, `qq`, `identity_number`, `passport_number`, `driving_number`, `travel_number`, `email`, `enterprise_name`, `property`, `registered_fund`, `legal_person`, `member_group`, `turnover`, `website`, `address`, `enterprise_address`, `introduce`, `collaborate`, `product`, `distribution`, `occupancy`, `direction`, `contacts`, `relation`, `contacts_phone`, `date`, `status`) VALUES
(6, 3, 1, 'qweqwe', 3, 'qweqw', '康熙来了', '男', '11111111111', 'asdasd', '234234', '498798', '456456465465465', '', '56456', 'sdfsfsfsdf', '', '', '股份公司,个人经营,有限公司', '0', '', '', '0', '', '', '', '', '', '', '', '', '', '', '', '', '2013-10-30', 0),
(7, 1, 2, 'sdfsdf', 2, 'sdfdsf', 'sdfsdfsdf', '男', '12312312313', '12312312', '12321321', '213123', '235659456456456456', '', '45646', '45645', '', '', '股份公司,有限公司,有限责任公司', '0', '', '', '0', '', '', NULL, '', '', '', NULL, '', '', '', '', '', '0000-00-00', 0),
(8, 1, 3, 'sdfsdf', 2, 'sdfdsf', 'sdfsdfsdf', '男', '12312312313', '12312312', '12321321', '213123', '235659456456456456', '', '45646', '45645', '', '', '股份公司,有限公司,有限责任公司', '0', '', '', '0', '', '', NULL, '', '', '', NULL, '', '', '', '', '', '0000-00-00', 0),
(9, 2, 4, '投资区域', 3, '自主', '会员姓名', '女', '11111111111', '123456', '234234', '498798', '456456465465465', 'qweqweqw', '123123123123', 'qweqw', 'aa@qq.com', '企业名称', '股份公司,有限公司,有限责任公司', '100000000', '法人', '会员组成成员', '200000000', 'http://www.baidu.com', '通讯地址', '企业所处行业位置', '个人介绍及社会身份', '企业主要合作方', '主要经营产品', '产品产地分布', '市场占有率', '业务发展规划', '紧急联系人', '关 系', '手机号码', '0000-00-00', 0),
(10, 2, 5, 'ada', 2, 'adasd', 'sdfsdf', '女', '11111111111', 'asdasd', '234234', '123123123123', '456456465465465', 'qweqweqw', '123123123123', 'qweqw', 'asd252392785@163.com', '', '个人经营,有限责任公司', '100', 'sdfsd', 'sdfs', '200', 'http://www.baidu.com', 'gdfg', 'dgdf', '个人介绍及社会身份', '企业主要合作方', '主要经营产品', '产品产地分布', '市场占有率', '业务发展规划', '紧急联系人', ' 系', '手机号码', '0000-00-00', 0),
(11, 1, 9, 'aaaa', 3, 'bbbb', '123', '男', '12312312313', '12312312', '12321321', '213123', '235659456456456456', '4', '45646', '45645', '', '', NULL, '0', '', '', '0', '', '', '', '', '', '', '', '', '', '', '', '', '0000-00-00', 0),
(12, 1, 7, 'sfsdf', 2, 'sfsdf', '123456', '女', '12345678991', '123123', '123123123', '49456564', '456456465465465', 'fghfghf', '123123123123', 'qweqw', '', '', NULL, '0', '', '', '0', '', '', '', '', '', '', '', '', '', '', '', '', '0000-00-00', 0),
(13, 1, 4, 'sdfsdf', 2, 'sdfdsf', 'qwe', '女', '12312312313', '12312312', '12321321', '213123', '235659456456456456', '', '45646', '45645', '', '', NULL, '0', '', '', '0', '', '', '', '', '', '', '', '', '', '', '', '', '0000-00-00', 0),
(14, 1, 1, 'adasd', 2, 'sdfdsf', 'qeww', '男', '12312312313', '13712345678', '12321321', '213123', '235659456456456456', '', '45646', '45645', '', '', NULL, '0', '', '', '0', '', '', '', '', '', '', '', '', '', '', '', '', '0000-00-00', 0),
(15, 1, 9, '投资区域', 3, 'SDFSDF', 'qeww', '男', '12312312313', '12312312', '12321321', '213123', '235659456456456456', '', '45646', '45645', '', '', NULL, '0', '', '', '0', '', '', '', '', '', '', '', '', '', '', '', '', '0000-00-00', 0),
(16, 1, 9, 'adasd', 2, 'aaa', 'qweqwe', '男', '12312312313', '12312312', '12321321', '213123', '235659456456456456', '', '45646', '45645', '', '', NULL, '0', '', '', '0', '', '', '', '', '', '', '', '', '', '', '', '', '2013-10-30', 0);
...
CREATE TABLE IF NOT EXISTS `app_member_resource` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='会员享有资源表' AUTO_INCREMENT=6 ;
...
(1, 1, 'admin', '管理员', 'e10adc3949ba59abbe56e057f20f883e', 1383189094, '192.168.1.100', 190, 1376561926, 1376561926, 0, 0),
