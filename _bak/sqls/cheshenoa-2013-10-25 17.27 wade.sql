...
CREATE TABLE IF NOT EXISTS `app_member_base` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='会员基本资料' AUTO_INCREMENT=11 ;
...
(6, 3, 'qweqwe', 3, 'qweqw', 'weqwe', '男', '11111111111', 'asdasd', '234234', '498798', '5', '456456465465465', '', '56456', 'sdfsfsfsdf', '', '', '股份公司,有限公司,有限责任公司', '0', '', '', '0', '', '', '', '', '', '', '', '', '', '', '', '', 0, 0),
...
(1, 1, 'admin', '管理员', 'e10adc3949ba59abbe56e057f20f883e', 1382672085, '192.168.1.102', 177, 1376561926, 1376561926, 0, 0),
