...
CREATE TABLE IF NOT EXISTS `app_group_node` (
  ...
  KEY `nodeId` (`node_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='组与节点关系表' AUTO_INCREMENT=114 ;
...
(1, 'admin', '管理员', 'e10adc3949ba59abbe56e057f20f883e', 1381721360, '192.168.1.100', 153, 1376561926, 1376561926, 0, 0),
