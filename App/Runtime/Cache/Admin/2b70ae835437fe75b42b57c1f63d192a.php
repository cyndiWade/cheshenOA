							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_1" method="post" class="form-horizontal">					 				<input type="hidden" name="id" value="<?php echo ($html_info["id"]); ?>" />									
									...
									<div class="alert alert-success hide">
										<button class="close" data-dismiss="alert"></button>
										验证成功
									</div>																		<div class="control-group">										<label class="control-label">车辆级别<span class="required">*（慎重操作！）</span></label>											<div class="controls">												<select class="small m-wrap" tabindex="1" name="cars_grade_id">																																			<?php if(is_array($car_grade_select)): foreach($car_grade_select as $key=>$vo): if(($html_info['cars_grade_id'] == $key)): ?><option value="<?php echo ($key); ?>" selected="selected"><?php echo ($vo); ?></option>													<?php else: ?>														<option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endif; endforeach; endif; ?>												</select>											</div>									</div>																		<div class="control-group">										<label class="control-label">车辆状态<span class="required">*（慎重操作！）</span></label>											<div class="controls">												<select class="small m-wrap" tabindex="1" name="car_status">																																			<?php if(is_array($car_status_select)): foreach($car_status_select as $key=>$vo): if(($html_info['car_status'] == $key)): ?><option value="<?php echo ($key); ?>" selected="selected"><?php echo ($vo); ?></option>													<?php else: ?>														<option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endif; endforeach; endif; ?>												</select>											</div>									</div>																			<div class="control-group">										<label class="control-label">车辆品牌<span class="required">*</span></label>										<div class="controls">											<input type="text" name="brand" value="<?php echo ($html_info["brand"]); ?>" data-required="1" class="span2 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">车牌号码<span class="required">*</span></label>										<div class="controls">											<input type="text" name="car_num" value="<?php echo ($html_info["car_num"]); ?>" data-required="1" class="span2 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">车辆类型<span class="required">*</span></label>										<div class="controls">											<input type="text" name="type" value="<?php echo ($html_info["type"]); ?>" data-required="1" class="span2 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">车辆颜色<span class="required">*</span></label>										<div class="controls">											<input type="text" name="color" value="<?php echo ($html_info["color"]); ?>" data-required="1" class="span2 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">车辆所有人<span class="required">*</span></label>										<div class="controls">											<input type="text" name="master" value="<?php echo ($html_info["master"]); ?>" data-required="1" class="span2 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">购入日期<span class="required">*</span></label>										<div class="controls">											<input type="text" name="buy_data" value="<?php echo ($html_info["buy_data"]); ?>"  readonly="" class="span2 wade_date">											<span class="add-on">												<i class="icon-calendar"></i>											</span>										</div>									</div>																		<div class="control-group">										<label class="control-label">购入单位<span class="required">*</span></label>										<div class="controls">											<input type="text" name="buy_num" value="<?php echo ($html_info["buy_num"]); ?>" data-required="1" class="span2 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">购入价格<span class="required">*</span></label>										<div class="controls">											<input type="text" name="buy_cost" value="<?php echo ($html_info["buy_cost"]); ?>" data-required="1" class="span2 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">初始公里数<span class="required">*</span></label>										<div class="controls">											<input type="text" name="initial_km" value="<?php echo ($html_info["initial_km"]); ?>" data-required="1" class="span2 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">所属部门<span class="required">*</span></label>										<div class="controls">											<input type="text" name="department" value="<?php echo ($html_info["department"]); ?>" data-required="1" class="span2 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">发动机号<span class="required">*</span></label>										<div class="controls">											<input type="text" name="engine_num" value="<?php echo ($html_info["engine_num"]); ?>" data-required="1" class="span2 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">车架号<span class="required">*</span></label>										<div class="controls">											<input type="text" name="frame_num" value="<?php echo ($html_info["frame_num"]); ?>" data-required="1" class="span2 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">座位数<span class="required">*</span></label>										<div class="controls">											<input type="text" name="seat_num" value="<?php echo ($html_info["seat_num"]); ?>" data-required="1" class="span2 m-wrap"/>										</div>									</div>										<div class="control-group">										<label class="control-label">备注：</label>										<div class="controls">											<textarea rows="3" name="remarks" class="span6 m-wrap"><?php echo ($html_info["remarks"]); ?></textarea>										</div>									</div>									
									<div class="form-actions">										
										<button type="submit" class="btn purple">编辑</button>
										<a href="?s=/Admin/CarsCompany/car_index/company_id/<?php echo ($company_id); ?>.html"><button type="button" class="btn">返回</button></a>
									</div>
								</form>
								<!-- END FORM-->
							</div>
...
-->
	...
	<!-- BEGIN PAGE LEVEL STYLES -->
	<script src="<?php echo (APP_PATH); ?>Public/media/js/app.js"></script>	<script src="<?php echo (APP_PATH); ?>Public/media/js/form-validation_CarsCompany_car_info.js"></script> 
	<!-- END PAGE LEVEL STYLES -->    
	<script>
