					...
					<div class="span12">
						...
						<div class="portlet box purple">
							...
							<div class="portlet-body">
								...
								<div class="row-fluid">
									<div class="span4">
										<h4>选择文件上传，一次最多选择5张</h4>										<!-- 上传按钮 -->										<div id="thumbnail-fine-uploader"></div>										<div id="triggerUpload" class="btn btn-primary" style="margin-top: 10px;">											  <i class="icon-upload icon-white">选择类型后"点我"上传</i>											</div>
									</div>
									<div class="span8">
										<div class="pull-right">																																	<div class="controls">												<select  id="type" tabindex="1" class="medium m-wrap">														<option value="">---请选择上传照片类型---</option>													<?php if(is_array($photo_select)): foreach($photo_select as $key=>$vo): ?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; ?>												</select>											</div>										
