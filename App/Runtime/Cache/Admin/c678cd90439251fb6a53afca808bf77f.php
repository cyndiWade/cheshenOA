					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">																		<a href="?s=/Admin/Staff/staff_edit/act/add/">
											<button id="sample_editable_1_new" class="btn green">
											添加新记录 <i class="icon-plus"></i>
											</button>										</a>								
									</div>								</div>
								<table class="table table-striped table-bordered table-hover sample_1">
									...
									<tbody>																		<?php if(is_array($staff_list)): $i = 0; $__LIST__ = $staff_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
											<td><?php echo ($vo["name"]); ?></td>
											<td class="hidden-480"><?php echo ($vo["sex"]); ?></a></td>
											<td class="hidden-480"><?php echo ($vo["name1"]); ?></td>
											<td class="center hidden-480"><?php echo ($vo["name2"]); ?></td>
											<td >												<a href="?s=/Admin/Staff/staff_edit/act/update/id/<?php echo ($vo["id"]); ?>">完善资料</a>												| <a href="?s=/Admin/Staff/staff_base_edit/act/delete/id/<?php echo ($vo["id"]); ?>" class="check">删除</a>																							</td>
