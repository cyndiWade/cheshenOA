				...
				<!-- BEGIN PAGE CONTENT-->				<div class="row-fluid">
					...
					<div class="span6">						<input type="hidden" name="group_id" value="<?php echo ($_GET['id']); ?>" />
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-comments"></i><?php echo ($group_name); ?>-已有用户</div>
								<div class="tools">
							...
							<div class="portlet-body ">
								<div class="dd" id="nestable_list_1">									
									<ol class="dd-list">																				<?php if($userYesList): if(is_array($userYesList)): $i = 0; $__LIST__ = $userYesList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="dd-item" data-id="<?php echo ($vo["id"]); ?>">
												<div class="dd-handle"><?php echo ($vo["account"]); ?></div>
											</li><?php endforeach; endif; else: echo "" ;endif; ?>										<?php else: ?>											<li class="dd-item" data-id="">												<div class="dd-handle">已有用户</div>											</li><?php endif; ?>										
									</ol>
								</div>
							</div>
						</div>
					...
					<div class="span6">
						<div class="portlet box green">
							<div class="portlet-title">
								<div class="caption"><i class="icon-comments"></i>用户列表</div>
								<div class="tools">
									<a href="javascript:;" class="collapse"></a>
									<a href="javascript:;" class="reload"></a>
								</div>
							...
							<div class="portlet-body">
								<div class="dd" id="nestable_list_2">
									<ol class="dd-list">										<?php if($htmlUser): if(is_array($htmlUser)): $i = 0; $__LIST__ = $htmlUser;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="dd-item" data-id="<?php echo ($vo["id"]); ?>">												<div class="dd-handle"><?php echo ($vo["account"]); ?></div>											</li><?php endforeach; endif; else: echo "" ;endif; ?>										<?php else: ?>											<li class="dd-item" data-id="">												<div class="dd-handle">待分配用户</div>											</li><?php endif; ?>
									</ol>
								</div>
							</div>
						</div>
...
-->
	...
	<script src="<?php echo (APP_PATH); ?>Public/media/js/app.js"></script>	<script src="<?php echo (APP_PATH); ?>Public/media/js/ui-nestable-group-user.js"></script>    
	<script>
