					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">																		<a href="?s=/Admin/Company/edit/act/add">
											<button id="sample_editable_1_new" class="btn green">
											添加区域 <i class="icon-plus"></i>
											</button>										</a>								
									</div>								</div>
								<table class="table table-striped table-bordered table-hover sample_1">
									<thead>
										<tr>
											...
											<th class="hidden-480">地理位置</th>
											<th class="hidden-480">备注信息</th>
											<th >操作</th>
										</tr>
									</thead>
									<tbody>																		<?php if(is_array($company_list)): $i = 0; $__LIST__ = $company_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
											<td><?php echo ($vo["id"]); ?></td>
											<td class="hidden-480"><?php echo ($vo["name"]); ?></a></td>
											<td class="hidden-480"><?php echo ($vo["region_name"]); ?></td>
											<td class="center hidden-480"><?php echo ($vo["remarks"]); ?></td>
											<td >												<a href="?s=/Admin/Personnel/department/company_id/<?php echo ($vo["id"]); ?>">查看部门</a>												| <a href="?s=/Admin/Company/edit/act/update/id/<?php echo ($vo["id"]); ?>">编辑</a>												| <a href="?s=/Admin/Company/edit/act/delete/id/<?php echo ($vo["id"]); ?>" class="check">删除</a>																							</td>
