							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_1" method="post" class="form-horizontal">                     
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" disabled="disabled" value="" data-required="1" class="span6 m-wrap"/>
										</div>
									</div>																		<div class="control-group">										<label class="control-label">会员级别<span class="required">（慎重操作！）*</span></label>											<div class="controls">												<select class="small m-wrap" tabindex="1" name="member_rank_id">																																			<?php if(is_array($rank_select)): foreach($rank_select as $key=>$vo): if(($member_rank_id == $key)): ?><option value="<?php echo ($key); ?>" selected="selected"><?php echo ($vo); ?></option>													<?php else: ?>														<option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endif; endforeach; endif; ?>												</select>											</div>									</div>																		<div class="control-group">										<label class="control-label">注册账号<span class="required">（慎重操作！）*</span></label>										<div class="controls">											<input type="text" placeholder="输入用户账号，搜索用户" class="m-wrap" id="ipt_content"><button class="btn blue" id="btn_search" type="button">搜索!</button>											结果为：											<select tabindex="1" class="medium m-wrap" name="member_id" id="select_member">												<option value="">--请选择用户--</option>											</select>										</div>									</div>																		<div class="control-group">										<label class="control-label"><?php echo ($Lang["card_number"]); ?><span class="required">*</span></label>										<div class="controls">											<input type="text" name="card_number" value="" data-required="1" class="span6 m-wrap"/>										</div>									</div>																			<!-- 									<?php if(($member_rank_id == 9)): ?><div class="control-group">										<label class="control-label">股东会员卡<span class="required">*</span></label>										<div class="controls">											<input type="text" name="card_number" value="" data-required="1" class="span6 m-wrap"/>										</div>									</div>																			<?php else: ?>																		<div class="control-group">										<label class="control-label">会员卡号<span class="required">*</span></label>										<div class="controls">											国家：											<select tabindex="1" class="least m-wrap" name="card_number[state]">												<option value="CN">CN</option>											</select>											区域：											<select tabindex="1" class="least m-wrap" name="card_number[area]">												<option value="0755">0755</option>											</select>											年份：											<select tabindex="1" class="least m-wrap" name="card_number[year]">												<option value="2013">2013</option>											</select>											俱乐部：											<select tabindex="1" class="small m-wrap" name="card_number[rank]">												<?php if(is_array($rank_content_select)): foreach($rank_content_select as $key=>$vo): if(($rank == $key)): ?><option value="<?php echo ($key); ?>" selected="selected"><?php echo ($vo); ?></option>													<?php else: ?>														<option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endif; endforeach; endif; ?>											</select>											卡片属性：											<select tabindex="1" class="least m-wrap" name="card_number[type]">												<option value="H">会员</option>											</select>											卡本身编号：<input type="text" placeholder="会员卡号，5位" class="m-wrap" name="card_number_over" id="card_number">										</div>											</div><?php endif; ?>									-->																		<div class="control-group">										<label class="control-label"><?php echo ($Lang["area"]); ?><span class="required">*</span></label>										<div class="controls">											<input type="text" name="area" value="" data-required="1" class="span6 m-wrap"/>										</div>									</div>									<div class="control-group">										<label class="control-label"><?php echo ($Lang["source"]); ?><span class="required">*</span></label>											<div class="controls">												<select name="source" tabindex="1" class="medium m-wrap">																																			<?php if(is_array($source_select)): foreach($source_select as $key=>$vo): ?><option value="<?php echo ($key); ?>" ><?php echo ($vo); ?></option><?php endforeach; endif; ?>																									</select>：												<input type="text" name="source_content">											</div>									</div>																		<div class="control-group">										<label class="control-label"><?php echo ($Lang["name"]); ?><span class="required">*</span></label>										<div class="controls">											<input type="text" name="name" value="" class="span6 m-wrap"/>										</div>									</div>																							<div class="control-group">										<label class="control-label"><?php echo ($Lang["sex"]); ?><span class="required">*</span></label>										<div class="controls">											<label class="radio">												<input type="radio" name="sex" value="男" checked="checked">													男											</label>											<label class="radio">												<input type="radio" name="sex" value="女"  />													女											</label>  										</div>									</div>																		<div class="control-group">										<label class="control-label">手机号码<span class="required">*</span></label>										<div class="controls">											<input type="text" name="mobile_phone" value="" class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">电    话<span class="required">*</span></label>										<div class="controls">											<input type="text" name="phone" value="" class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">传真号码<span class="required">*</span></label>										<div class="controls">											<input type="text" name="fax" value="" class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">联系QQ<span class="required">*</span></label>										<div class="controls">											<input type="text" name="qq" value="" class="span6 m-wrap"/>										</div>									</div>																						<div class="control-group">										<label class="control-label">身份证号码<span class="required">*</span></label>										<div class="controls">											<input type="text" name="identity_number" value="" class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">护照号码</label>										<div class="controls">											<input type="text" name="passport_number" value="" class="span6 m-wrap"/>										</div>									</div>																	<div class="control-group">										<label class="control-label">驾驶证号码<span class="required">*</span></label>										<div class="controls">											<input type="text" name="driving_number" value="" class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">行车证号码<span class="required">*</span></label>										<div class="controls">											<input type="text" name="travel_number" value="" class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">驾龄<span class="required">*</span></label>										<div class="controls">											<input type="text" name="driving_years" value="" class="span1 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">入会日期<span class="required">（慎重操作！）*</span></label>										<div class="controls">											<input type="text" name="date" value=""  readonly="" class="span2 wade_date">											<span class="add-on">												<i class="icon-calendar"></i>											</span>										</div>									</div>																		<div class="control-group">										<label class="control-label">到期日期<span class="required">（慎重操作！）*</span></label>										<div class="controls">											<input type="text" name="over_date" value=""  readonly="" class="span2 wade_date">											<span class="add-on">												<i class="icon-calendar"></i>											</span>										</div>									</div>																		<div class="control-group">										<label class="control-label">电子邮箱</label>										<div class="controls">											<div class="input-icon left">												<i class="icon-envelope"></i>												<input type="text" name="email" placeholder="电子邮箱" class="m-wrap ">    											</div>										</div>									</div>																		<div class="control-group">										<label class="control-label">企业名称</label>										<div class="controls">											<input type="text" name="enterprise_name" value="" class="span6 m-wrap"/>										</div>									</div>										<div class="control-group">										<label class="control-label">经营组织/在职公司类型</label>										<div class="controls">											<label class="checkbox">												<input type="checkbox" name="property[1]" value="股份公司" /> 股份公司											</label>											<label class="checkbox">												<input type="checkbox" name="property[2]" value="个人经营" /> 个人经营											</label>											<label class="checkbox">												<input type="checkbox" name="property[3]" value="有限公司" /> 有限公司											</label>											<label class="checkbox">												<input type="checkbox" name="property[4]" value="有限责任公司" /> 有限责任公司											</label>											<label class="checkbox">												<input type="checkbox" name="property[5]" value="合资公司" /> 合资公司											</label>										</div>									</div>																				<div class="control-group">										<label class="control-label">注册资金</label>										<div class="controls">											<div class="input-prepend input-append">												<span class="add-on">￥</span>												<input type="text" class="m-wrap" name="registered_fund">												<span class="add-on">万</span>											</div>										</div>									</div>																		<div class="control-group">										<label class="control-label">法人</label>										<div class="controls">											<input type="text" name="legal_person" value="" class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">会员组成成员</label>										<div class="controls">											<input type="text" name="member_group" value="" class="span6 m-wrap"/>										</div>									</div>										<div class="control-group">										<label class="control-label">近三年营业额</label>										<div class="controls">											<div class="input-prepend input-append">												<span class="add-on">￥</span>												<input type="text" class="m-wrap" name="turnover">												<span class="add-on">万</span>											</div>										</div>									</div>																		<div class="control-group">										<label class="control-label">企业网址</label>										<div class="controls">											<input type="text" name="website" value="" class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">通讯地址</label>										<div class="controls">											<input type="text" name="address" value="" class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">企业所处行业位置</label>										<div class="controls">											<input type="text" name="enterprise_address" value="" class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">个人介绍及社会身份</label>										<div class="controls">											<textarea rows="3" name="introduce" class="span6 m-wrap"></textarea>										</div>									</div>																		<div class="control-group">										<label class="control-label">企业主要合作方</label>										<div class="controls">											<textarea rows="3" name="collaborate" class="span6 m-wrap"></textarea>										</div>									</div>																		<div class="control-group">										<label class="control-label">主要经营产品</label>										<div class="controls">											<input type="text" name="product" value="" class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">产品产地分布</label>										<div class="controls">											<input type="text" name="distribution" value="" class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">市场占有率</label>										<div class="controls">											<input type="text" name="occupancy" value="" class="span6 m-wrap"/>										</div>									</div>											<div class="control-group">										<label class="control-label">业务发展规划</label>										<div class="controls">											<textarea rows="3" name="direction" class="span6 m-wrap"></textarea>										</div>									</div>																		<div class="control-group">										<label class="control-label">紧急联系人</label>										<div class="controls">											<input type="text" name="contacts" value="" class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">关   系</label>										<div class="controls">											<input type="text" name="relation" value="" class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">手机号码</span></label>										<div class="controls">											<input type="text" name="contacts_phone" value="" class="span6 m-wrap"/>										</div>									</div>
									<div class="form-actions">										
										<button type="submit" class="btn purple">添加</button>
										<a href="?s=/Admin/Rank/rank_list/member_rank_id/<?php echo ($member_rank_id); ?>.html"><button type="button" class="btn">返回</button></a>
									</div>
								</form>
								<!-- END FORM-->
							</div>
...
-->
	...
	<!-- BEGIN PAGE LEVEL STYLES -->
	<script src="<?php echo (APP_PATH); ?>Public/media/js/app.js"></script>	<script src="<?php echo (APP_PATH); ?>Public/media/js/form-validation_member_base_add.js"></script> 
	<!-- END PAGE LEVEL STYLES -->    
	<script>
		jQuery(document).ready(function() {   
		   // initiate layout and plugins
		   App.init();
		   FormValidation.init();						/* 最大长度限制 */			$('#card_number').maxLength(6);			
		});
	</script>
	<!-- END JAVASCRIPTS -->   
