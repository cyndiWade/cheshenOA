...
-->
	...
	<script src="<?php echo (APP_PATH); ?>Public/media/js/form-validation_member_add.js"></script> 
	<!-- END PAGE LEVEL STYLES -->    
	<script>
