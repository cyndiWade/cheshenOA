							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_1" method="post" class="form-horizontal">                     
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="name" value="<?php echo ($department_info["name"]); ?>" data-required="1" class="span6 m-wrap"/>
										</div>
									</div>																		<div class="control-group">										<label class="control-label">负责人<span class="required">*</span></label>										<div class="controls">											<input type="text" name="principal" value="<?php echo ($department_info["principal"]); ?>" data-required="1"class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">备注<span class="required">*</span></label>										<div class="controls">											<input type="text" name="remarks" value="<?php echo ($department_info["remarks"]); ?>" data-required="1"class="span6 m-wrap"/>										</div>									</div>
									<div class="form-actions">										
										<button type="submit" class="btn purple">编辑</button>
										<a href="?s=/Admin/Personnel/department/company_id/<?php echo ($company_id); ?>"><button type="button" class="btn">返回</button></a>
									</div>
								</form>
								<!-- END FORM-->
							</div>
...
-->
	...
	<script src="<?php echo (APP_PATH); ?>Public/media/js/form-validation_department_edit.js"></script> 
	<!-- END PAGE LEVEL STYLES -->    
	<script>
