					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-globe"></i><?php echo ($TITLE_NAME); ?></div>
								<div class="tools">
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-bordered table-hover sample_1">
									<thead>
										<tr>
											<th>会员编号</th>
											<th class="hidden-480">会员级别</th>
											<th class="hidden-480">真实姓名</th>
											<th class="hidden-480">艺名</th>											<th class="hidden-480">姓别</th>											<th class="hidden-480">入会日期</th>											<th class="hidden-480">协议编号</th>											<th class="hidden-480">试驾卡区间</th>										<!--											<th class="hidden-480">微信</th>											<th class="hidden-480">QQ号码</th>											<th class="hidden-480">邮箱</th>											<th class="hidden-480">身份证号</th>											<th class="hidden-480">出生日期</th>											<th class="hidden-480">驾龄</th>											<th class="hidden-480">手机号码</th>											<th class="hidden-480">常驻地址</th>											<th class="hidden-480">公司名称</th>														<th class="hidden-480">行业类别</th>											<th class="hidden-480">年营业额</th>											<th class="hidden-480">公司地址</th>											<th class="hidden-480">邀请人</th>											<th class="hidden-480">备注</th>										 -->	
									...
									<tbody>																		<?php if(is_array($member_base_list)): $i = 0; $__LIST__ = $member_base_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
											...
											<td class="center hidden-480"><?php echo ($vo["rank_name"]); ?></a></td>
											<td class="center hidden-480"><?php echo ($vo["name"]); ?></td>											<td class="center hidden-480">暂无</td>											<td class="center hidden-480"><?php echo ($vo["sex"]); ?></td>
											<td class="center hidden-480"><?php echo ($vo["date"]); ?></td>											<td class="center hidden-480">暂无</td>										<!--											<td class="center hidden-480">暂无</td>											<td class="center hidden-480"><?php echo ($vo["qq"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["email"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["identity_number"]); ?></td>											<td class="center hidden-480">暂无</td>											<td class="center hidden-480">暂无</td>											<td class="center hidden-480"><?php echo ($vo["mobile_phone"]); ?></td>											<td class="center hidden-480">暂无</td>											<td class="center hidden-480">暂无</td>											<td class="center hidden-480">暂无</td>											<td class="center hidden-480"><?php echo ($vo["source_content"]); ?></td>											<td class="center hidden-480">暂无</td>											<td class="center hidden-480">暂无</td>											<td class="center hidden-480">暂无</td>										-->											<td class="center hidden-480">暂无</td>											 
											<td class="center">												<a href="?s=/Admin/Order/edit_apply/act/add/member_base_id/<?php echo ($vo["id"]); ?>.html">下单</a>											</td>											
...
-->
	...
	<script type="text/javascript" src="<?php echo (APP_PATH); ?>Public/media/js/app.js"></script>  	<script type="text/javascript" src="<?php echo (APP_PATH); ?>Public/media/js/table-managed-Member-all_user_info.js"></script>   	
