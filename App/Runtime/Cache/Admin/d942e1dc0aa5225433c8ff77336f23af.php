					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i><?php echo ($setName); ?></div>
								<div class="tools">
							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_1" method="post" class="form-horizontal">                     
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="name" value="<?php echo ($company_info["name"]); ?>" data-required="1" class="span6 m-wrap"/>
										</div>
									</div>																		<div class="control-group">													<label class="control-label">地理位置<span class="required">*</span></label>																				<div class="controls">													<select tabindex="1" class="small m-wrap"  name="region_id">													<option value="">--地理位置--</option>													<?php if(is_array($city_list)): $i = 0; $__LIST__ = $city_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo['region_id'] == $company_info['region_id'])): ?>value1															<option value="<?php echo ($vo["region_id"]); ?>" selected=selected ><?php echo ($vo["region_name"]); ?></option>														<?php else: ?>															<option value="<?php echo ($vo["region_id"]); ?>" ><?php echo ($vo["region_name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>																									</select>										</div>												</div>																		<div class="control-group">										<label class="control-label">备注</label>													<div class="controls">														<textarea name="remarks" class="span6 m-wrap" rows="3"><?php echo ($company_info["remarks"]); ?></textarea>													</div>												</div>
									<div class="form-actions">										
										<button type="submit" class="btn purple">编辑</button>
										<a href="?s=/Admin/Company/index"><button type="button" class="btn">返回</button></a>
									</div>
								</form>
								<!-- END FORM-->
							</div>
...
-->
	...
	<script src="<?php echo (APP_PATH); ?>Public/media/js/form-validation_company_edit.js"></script> 
	<!-- END PAGE LEVEL STYLES -->    
	<script>
