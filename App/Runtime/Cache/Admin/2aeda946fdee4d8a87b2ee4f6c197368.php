...
-->
			...
			<ul class="page-sidebar-menu wade_menu">
				...
				<li class="">
					...
					<ul class="sub-menu">
						...
						<li >
							<a href="<?php echo U('Admin/Rank/rank_list',array('rank'=>5));?>">
							5万级别会员</a>
						</li>
						<li >
							<a href="<?php echo U('Admin/Rank/rank_list',array('rank'=>10));?>">
							10万级别会员</a>
						</li>				
						<li >
							<a href="<?php echo U('Admin/Rank/rank_list',array('rank'=>20));?>">
							20万级别会员</a>
						</li>
						<li >
							<a href="<?php echo U('Admin/Rank/rank_list',array('rank'=>40));?>">
							40万级别会员</a>
						</li>
						<li >
							<a href="<?php echo U('Admin/Rank/rank_list',array('rank'=>80));?>">
							80万级别会员</a>
						</li>
						<li >
							<a href="<?php echo U('Admin/Rank/rank_list',array('rank'=>other));?>">
							车神优选会员</a>
						</li>
						<li >
							<a href="<?php echo U('Admin/Rank/rank_list',array('rank'=>other));?>">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-globe"></i><?php echo ($rank_level); ?>列表</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">														<a href="?s=/Admin/Rank/member_base_add/rank/<?php echo ($rank); ?>/rank_type/<?php echo ($rank_type["member"]); ?>.html">
											<button id="sample_editable_1_new" class="btn green">
											添加<?php echo ($rank_level); ?> <i class="icon-plus"></i>
											</button>										</a>								
									</div>																		<?php if(($rank == 40)): ?><div class="btn-group">																		<a href="?s=/Admin/Rank/member_base_add/rank/<?php echo ($rank); ?>/rank_type/<?php echo ($rank_type["shareholder"]); ?>.html">											<button id="sample_editable_1_new" class="btn green">											添加股东会员 <i class="icon-plus"></i>											</button>										</a>																	</div><?php endif; ?>								</div>
								<table class="table table-striped table-bordered table-hover sample_1">
									<thead>
										<tr>
											<th>会员编号</th>
											<th class="hidden-480">会员姓名</th>
											<th class="hidden-480">会员性别</th>
											<th class="hidden-480">会员等级</th>											<th class="hidden-480">会员类型</th>											<th class="hidden-480">手机号码</th>											<th class="hidden-480">电    话</th>
											<th class="hidden-480">操作</th>
										</tr>
									</thead>
									<tbody>																		<?php if(is_array($member_base_list)): $i = 0; $__LIST__ = $member_base_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
											<td><?php echo ($vo["id"]); ?></td>
											<td class="hidden-480"><?php echo ($vo["name"]); ?></a></td>
											<td class="hidden-480"><?php echo ($vo["sex"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["rank"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["rank_type_name"]); ?></td>
											<td class="center hidden-480"><?php echo ($vo["mobile_phone"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["phone"]); ?></td>
											<td class="center">												<a href="?s=/Admin/Rank/member_base_edit/id/<?php echo ($vo["id"]); ?>/rank_type/<?php echo ($vo["rank_type"]); ?>.html">基本资料</a>												| <a href="#">行程信息</a>												| <a href="#">生活信息</a>												| <a href="#">证件复印件</a>											</td>
	...
	<script type="text/javascript" src="<?php echo (APP_PATH); ?>Public/media/js/app.js"></script>	<script type="text/javascript" src="<?php echo (APP_PATH); ?>Public/media/js/table-managed-Rank-rank_list.js"></script>   	
