					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-globe"></i><?php echo ($member_rank_name); ?>列表</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">														<a href="?s=/Admin/Rank/member_base_add/member_rank_id/<?php echo ($member_rank_id); ?>.html">
											<button id="sample_editable_1_new" class="btn green">
											添加<?php echo ($member_rank_name); ?> <i class="icon-plus"></i>
											</button>										</a>								
									</div>								</div>
								<table class="table table-striped table-bordered table-hover sample_1">
									...
									<tbody>																		<?php if(is_array($member_base_list)): $i = 0; $__LIST__ = $member_base_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
											...
											<td class="hidden-480"><?php echo ($vo["sex"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["rank_name"]); ?></td>
											<td class="center hidden-480"><?php echo ($vo["mobile_phone"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["phone"]); ?></td>
											<td class="center">												<a href="?s=/Admin/Rank/member_base_edit/member_rank_id/<?php echo ($member_rank_id); ?>/id/<?php echo ($vo["id"]); ?>.html">基本资料</a>												| <a href="?s=/Admin/Rank/member_credit/member_rank_id/<?php echo ($member_rank_id); ?>/member_base_id/<?php echo ($vo["id"]); ?>.html">信用信息</a>												| <a href="?s=/Admin/Rank/member_life/member_rank_id/<?php echo ($member_rank_id); ?>/member_base_id/<?php echo ($vo["id"]); ?>.html">生活信息</a>												| <a href="?s=/Admin/Rank/member_photo/member_rank_id/<?php echo ($member_rank_id); ?>/member_base_id/<?php echo ($vo["id"]); ?>.html">证件复印件</a>											</td>
