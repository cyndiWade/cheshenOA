	...
	<div class="page-container row-fluid">			<!-- 左侧导航 -->		<!-- BEGIN SIDEBAR -->
			...
			<ul class="page-sidebar-menu wade_menu">
				...
				<li class="">
					...
					<ul class="sub-menu">	
						...
						<li >
							<a href="<?php echo U('Admin/Rank/rank_list',array('rank'=>gudong));?>">
							股东会员(40万级别)</a>
						</li>
						<li >
							<a href="<?php echo U('Admin/Rank/rank_list',array('rank'=>youxuan));?>">
							车神优选会员</a>
						</li>
						<li >
							<a href="<?php echo U('Admin/Rank/rank_list',array('rank'=>linshi));?>">
							临时租车会员</a>
						</li>
						<li >
							<a href="<?php echo U('Admin/Rank/rank_list',array('rank'=>shijia));?>">
							试驾系统会员</a>
						</li>
						 -->
					</ul>
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				</div>								<div class="control-group">					<label class="control-label"></label>					<div class="controls">						<select class="span6 m-wrap select_group" data-placeholder="Choose a Category" tabindex="1">															<?php if(is_array($group_list)): $i = 0; $__LIST__ = $group_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo["id"] == $group_id) ): ?><option value="<?php echo ($vo["id"]); ?>" selected="selected"><?php echo ($vo["name"]); ?></option>								<?php else: ?>									<option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>													</select>					</div>				</div>
				<div class="row-fluid">
					<div class="span6">
						<div class="portlet box blue">
							...
							<div class="portlet-body ">
								<div class="dd" id="nestable_list_1">									
									<ol class="dd-list">																				<?php if($group_auto): if(is_array($group_auto)): $i = 0; $__LIST__ = $group_auto;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="dd-item" data-id="<?php echo ($vo["id"]); ?>">
												<div class="dd-handle"><?php echo ($vo["title"]); ?>：[节点id：<?php echo ($vo["id"]); ?>]--[父ID：<?php echo ($vo["pid"]); ?>]</div>
											</li><?php endforeach; endif; else: echo "" ;endif; ?>										<?php else: ?>											<li class="dd-item" data-id="">												<div class="dd-handle">已有组权限</div>											</li><?php endif; ?>										
									</ol>
								</div>
							</div>
						</div>
						...
						<div class="portlet box green">
							...
							<div class="portlet-body">
								<div class="dd" id="nestable_list_2">
									<ol class="dd-list">										<?php if($allot_list): if(is_array($allot_list)): $i = 0; $__LIST__ = $allot_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="dd-item" data-id="<?php echo ($vo["id"]); ?>">												<div class="dd-handle"><?php echo ($vo["title"]); ?>：[系统名：<?php echo ($vo["name"]); ?>]</div>											</li><?php endforeach; endif; else: echo "" ;endif; ?>										<?php else: ?>											<li class="dd-item" data-id="">												<div class="dd-handle">待非配节点</div>											</li><?php endif; ?>
									</ol>
								</div>
							</div>
						</div>
...
-->
	...
	<script>
		jQuery(document).ready(function() {       
		   ...
		   App.init();
		   UINestable.init();			$('.select_group').change(function () {				window.location.href='?s=/Admin/Rbac/group_node/group_id/'+$(this).val();			});
		});
	</script>
	<!-- END JAVASCRIPTS -->
