					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-globe"></i><?php echo ($company_name); ?>--部门列表</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">																		<a href="?s=/Admin/Personnel/department_edit/act/add/company_id/<?php echo ($company_id); ?>">
								...
								<table class="table table-striped table-bordered table-hover sample_1">
									...
									<tbody>																		<?php if(is_array($department_list)): $i = 0; $__LIST__ = $department_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
											<td><?php echo ($vo["name"]); ?></td>
											<td class="hidden-480"><?php echo ($vo["principal"]); ?></a></td>
											<td class="hidden-480"><?php echo ($vo["create_time"]); ?></td>
											<td class="center hidden-480"><?php echo ($vo["remarks"]); ?></td>
											<td >												<a href="?s=/Admin/Personnel/occupation/department_id/<?php echo ($vo["id"]); ?>">查看职位</a>												| <a href="?s=/Admin/Personnel/department_edit/act/update/id/<?php echo ($vo["id"]); ?>">编辑</a>												| <a href="?s=/Admin/Personnel/department_edit/act/delete/id/<?php echo ($vo["id"]); ?>" class="check">删除</a>																							</td>
