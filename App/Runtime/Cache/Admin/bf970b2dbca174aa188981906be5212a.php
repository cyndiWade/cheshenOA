				...
				<li class="">
					...
					<ul class="sub-menu">
						...
						<li >
							...
							<a href="#login.html" onclick="alert('开发中')">
							司机管理</a>
						</li>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">																		<a href="?s=/Admin/CarsAudit/edit/act/add/cars_id/<?php echo ($cars_id); ?>.html">
								...
								<table class="table table-striped table-bordered table-hover sample_1">
									<thead>
										<tr>
											<th>序号</th>
											<th class="hidden-480">年审日期</th>
											<th class="hidden-480">年审项目</th>
											<th class="hidden-480">年审状态</th>											<th class="hidden-480">下次年审日期</th>
											<th >操作</th>
										</tr>
									</thead>
									<tbody>																		<?php if(is_array($html_list)): $i = 0; $__LIST__ = $html_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
											<td><?php echo ($i); ?></td>
											<td class="hidden-480"><?php echo ($vo["year_audit_date"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["year_audit_item"]); ?></td>
											<td class="center hidden-480"><?php echo ($vo["year_audit_state"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["year_audit_next"]); ?></td>
											<td >												<a href="?s=/Admin/CarsAudit/edit/act/update/cars_id/<?php echo ($cars_id); ?>/id/<?php echo ($vo["id"]); ?>.html">编辑</a>												| <a href="?s=/Admin/CarsAudit/edit/act/delete/id/<?php echo ($vo["id"]); ?>.html" class="check">删除</a>											</td>
...
-->
	...
	<script type="text/javascript" src="<?php echo (APP_PATH); ?>Public/media/js/app.js"></script>	<script type="text/javascript" src="<?php echo (APP_PATH); ?>Public/media/js/table-managed-CarsAudit-index.js"></script>    
