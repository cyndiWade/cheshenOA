							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-bordered table-hover sample_1">
									...
									<tbody>																		<?php if(is_array($html_list)): $i = 0; $__LIST__ = $html_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
											...
											<td >												<?php if(($vo['order_state'] == $order_state[1]['order_status']) ): ?><a href="?s=/Admin/Order/cars_arrange_edit/id/<?php echo ($vo["id"]); ?>.html" class="check">处理</a> | 												<?php else: ?> 													<a href="?s=/Admin/Order/order_send_msg/id/<?php echo ($vo["id"]); ?>.html" class="check">发送短信</a> |<?php endif; ?>																		<a href="?s=/Admin/Order/order_history_list/order_id/<?php echo ($vo["id"]); ?>.html">跟进记录</a>											</td>
