							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_1" method="post" class="form-horizontal">					 				<input type="hidden" name="id" value="<?php echo ($life_info["id"]); ?>" />									
									...
									<div class="alert alert-success hide">
										<button class="close" data-dismiss="alert"></button>
										验证成功
									</div>																		<div class="control-group">										<label class="control-label">喜爱的食物<span class="required">*</span></label>										<div class="controls">											<input type="text" name="like_food" value="<?php echo ($life_info["like_food"]); ?>"  class="span6 m-wrap"/>										</div>									</div>																				<div class="control-group">										<label class="control-label">忌口的食物<span class="required">*</span></label>										<div class="controls">											<input type="text" name="not_like_food" value="<?php echo ($life_info["not_like_food"]); ?>" data-required="1" class="span6 m-wrap"/>										</div>									</div>																			<div class="control-group">										<label class="control-label">个人爱好<span class="required">*</span></label>										<div class="controls">											<input type="text" name="hobby" value="<?php echo ($life_info["hobby"]); ?>" data-required="1" class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">菜品偏重口味</label>										<input type="hidden" value="<?php echo ($life_info["taste_select"]); ?>" id="ipt_check_have" />																				<div class="controls">														<label class="checkbox">												<input type="checkbox" name="taste[qd]" value="清淡" class="ipt_check"/> 清淡											</label>											<label class="checkbox">												<input type="checkbox" name="taste[d]" value="淡" class="ipt_check"/> 淡											</label>											<label class="checkbox">												<input type="checkbox" name="taste[sz]" value="适中" class="ipt_check"/> 适中											</label>											<label class="checkbox">												<input type="checkbox" name="taste[x]" value="咸" class="ipt_check"/> 咸											</label>													</div>										<div class="controls">											<label class="checkbox">												<input type="checkbox" name="taste[px]" value="偏咸" class="ipt_check"/> 偏咸											</label>											<label class="checkbox">												<input type="checkbox" name="taste[s]" value="酸" class="ipt_check"/> 酸											</label>											<label class="checkbox">												<input type="checkbox" name="taste[t]" value="甜" class="ipt_check"/> 甜											</label>											<label class="checkbox">												<input type="checkbox" name="taste[l]" value="辣" class="ipt_check"/> 辣											</label>										</div>																				<div class="controls">											<label class="text">												其他：												<input type="text" name="taste[qt]"  value="<?php echo ($life_info['taste']->qt); ?>" class="span2 m-wrap">											</label>										</div>									</div>																					<div class="control-group">										<label class="control-label">喜欢的汤品：</label>										<div class="controls">											<input type="text" name="like_broth" value="<?php echo ($life_info["like_broth"]); ?>" data-required="1" class="span6 m-wrap"/>										</div>									</div>																<div class="control-group">										<label class="control-label">喜欢的水果：</label>										<div class="controls">											<input type="text" name="like_fruits" value="<?php echo ($life_info["like_fruits"]); ?>" data-required="1" class="span6 m-wrap"/>										</div>									</div>															<div class="control-group">										<label class="control-label">喜欢的饮品：</label>										<div class="controls">											<input type="text" name="like_drink" value="<?php echo ($life_info["like_drink"]); ?>" data-required="1" class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">喜欢的鲜花：</label>										<div class="controls">											<input type="text" name="liek_flower" value="<?php echo ($life_info["liek_flower"]); ?>" data-required="1" class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">喜欢的酒类品牌：</label>										<div class="controls">											<input type="text" name="like_liquor_brand" value="<?php echo ($life_info["like_liquor_brand"]); ?>" data-required="1" class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">喜欢的颜色：</label>										<div class="controls">											<input type="text" name="like_color" value="<?php echo ($life_info["like_color"]); ?>" data-required="1" class="span6 m-wrap"/>										</div>									</div>																					<div class="control-group">										<label class="control-label">是否有室内运动的习惯：</label>										<div class="controls">											<input type="text" name="exercise" value="<?php echo ($life_info["exercise"]); ?>" data-required="1" class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">其他说明：</label>										<div class="controls">											<textarea rows="3" name="other" class="span6 m-wrap"><?php echo ($life_info["other"]); ?></textarea>										</div>									</div>
...
-->
	...
	<!-- BEGIN PAGE LEVEL STYLES -->
	<script src="<?php echo (APP_PATH); ?>Public/media/js/app.js"></script>	<script src="<?php echo (APP_PATH); ?>Public/media/js/form-validation_member_life.js"></script> 
	<!-- END PAGE LEVEL STYLES -->    
	<script>
