							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_1" method="post" class="form-horizontal">                     
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="relation" value="<?php echo ($staff_family_info["relation"]); ?>" data-required="1" class="span6 m-wrap"/>
										</div>
									</div>																		<div class="control-group">										<label class="control-label">姓名<span class="required">*</span></label>										<div class="controls">											<input type="text" name="name" value="<?php echo ($staff_family_info["name"]); ?>" data-required="1"class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">工作单位<span class="required">*</span></label>										<div class="controls">											<input type="text" name="company" value="<?php echo ($staff_family_info["company"]); ?>" data-required="1"class="span6 m-wrap"/>										</div>									</div>																		<div class="control-group">										<label class="control-label">住址及号码<span class="required">*</span></label>										<div class="controls">											<input type="text" name="address" value="<?php echo ($staff_family_info["address"]); ?>" data-required="1"class="span6 m-wrap"/>										</div>									</div>
									<div class="form-actions">										
										<button type="submit" class="btn purple">编辑</button>
										<a href="?s=/Admin/Staff/staff_edit/act/update/id/<?php echo ($base_id); ?>"><button type="button" class="btn">返回</button></a>
									</div>
								</form>
								<!-- END FORM-->
							</div>
...
-->
	...
	<script src="<?php echo (APP_PATH); ?>Public/media/js/form-validation_staff_vitae_family.js"></script> 
	<!-- END PAGE LEVEL STYLES -->    
	<script>
