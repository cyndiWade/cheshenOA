					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-globe"></i><?php echo ($Department_info["name"]); ?>-负责人：<?php echo ($Department_info["principal"]); ?></div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">																		<a href="?s=/Admin/Personnel/occupation_edit/act/add/id/<?php echo ($Department_info["id"]); ?>">
											<button id="sample_editable_1_new" class="btn green">
											添加职位<i class="icon-plus"></i>
											</button>										</a>								
									</div>								</div>
								<table class="table table-striped table-bordered table-hover sample_1">
									<thead>
										<tr>
											<th>职位名称</th>
											<th class="hidden-480">编制人数</th>
											<th class="hidden-480">添加时间</th>
											<th class="hidden-480">备注信息</th>
											<th >操作</th>
										</tr>
									</thead>
									<tbody>																		<?php if(is_array($occupation_list)): $i = 0; $__LIST__ = $occupation_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
											<td><?php echo ($vo["name"]); ?></td>
											<td class="hidden-480"><?php echo ($vo["num"]); ?></a></td>
											<td class="hidden-480"><?php echo ($vo["create_time"]); ?></td>
											<td class="center hidden-480"><?php echo ($vo["remarks"]); ?></td>
											<td >												<a href="?s=/Admin/Staff/index/occupation_id/<?php echo ($vo["id"]); ?>" >查看员工</a>												| <a href="?s=/Admin/Personnel/occupation_edit/act/update/id/<?php echo ($vo["id"]); ?>">编辑</a>												| <a href="?s=/Admin/Personnel/occupation_edit/act/delete/id/<?php echo ($vo["id"]); ?>" class="check">删除</a>																							</td>
