					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-globe"></i><?php echo ($TITILE_NAME); ?></div>
								<div class="tools">
								...
								<table class="table table-striped table-bordered table-hover sample_1">
									<thead>
										<tr>
											...
											<th class="hidden-480">用户姓名</th>											<th class="hidden-480">驾龄</th>
											<th class="hidden-480">开始日期</th>											<th class="hidden-480">预计还车</th>											<th class="hidden-480">归还日期</th>											<th class="hidden-480">总用车天数</th>											<th class="hidden-480">超过天数</th>											<th class="hidden-480">申请车辆</th>											<th class="hidden-480">是否需要司机</th>											<th class="hidden-480">备注</th>											<th class="hidden-480">订单状态</th>
											<th >操作</th>
										</tr>
									</thead>
									<tbody>																		<?php if(is_array($html_list)): $i = 0; $__LIST__ = $html_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
											<td><?php echo ($vo["order_num"]); ?></td>
											<td class="hidden-480"><?php echo ($vo["order_from"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["name"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["driving_years"]); ?></td>
											<td class="center hidden-480"><?php echo ($vo["start"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["estimate_over"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["over"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["length"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["exceed_date"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["brand"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["is_need_driver"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["remarks"]); ?></td>												<td class="center hidden-480"><?php echo ($vo["order_state_explain"]); ?> - <?php echo ($vo["give_back_state_explain"]); ?></td>
											<td >												<?php if(($vo['give_back_state'] == $give_back_state[0]['status_num']) ): ?><a href="?s=/Admin/Order/give_back_car_edit/id/<?php echo ($vo["id"]); ?>.html" class="check">填写还车信息</a> | 												<?php else: endif; ?>																		<a href="?s=/Admin/Order/order_history_list/order_id/<?php echo ($vo["id"]); ?>.html">跟进记录</a>											<!-- 	| <a href="?s=/Admin/CarsAudit/edit/act/delete/id/<?php echo ($vo["id"]); ?>.html" class="check">删除</a>											-->											</td>
...
-->
	...
	<script type="text/javascript" src="<?php echo (APP_PATH); ?>Public/media/js/app.js"></script>	<script type="text/javascript" src="<?php echo (APP_PATH); ?>Public/media/js/table-managed-Order-give_back_car_list.js"></script>    
