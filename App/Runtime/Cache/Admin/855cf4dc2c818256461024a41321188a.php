							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_1" method="post" class="form-horizontal">					 				<input type="hidden" name="id" value="<?php echo ($html_info["id"]); ?>" />									<input type="hidden" name="member_base_id" value="<?php echo ($html_info['member_base_id']); ?>" />									
									...
									<div class="alert alert-success hide">
										<button class="close" data-dismiss="alert"></button>
										验证成功
									</div>																			<div class="control-group">											<label class="control-label">订单号<span class="required">*</span></label>											<div class="controls">												<input type="text"  class="span5" value="<?php echo ($html_info["order_num"]); ?>" disabled="disabled" placeholder="自动生成">											</div>										</div>																				<div class="control-group">											<label class="control-label">用车开始时间<span class="required">*</span></label>											<div class="controls">																							<input type="text" name="start" value="<?php echo ($html_info["start"]); ?>" readonly="" class="span3 bootstrap_date_fn">												<span class="add-on">													<i class="icon-calendar"></i>												</span>											</div>										</div>																				<div class="control-group">											<label class="control-label">预计还车时间<span class="required">*</span></label>											<div class="controls">																							<input type="text" name="estimate_over" value="<?php echo ($html_info["estimate_over"]); ?>" readonly="" class="span3 bootstrap_date">												<span class="add-on">													<i class="icon-calendar"></i>												</span>											</div>										</div>																				<div class="control-group">											<label class="control-label"></label>											<div class="controls">																							<button type="button" class="btn blue demand" data-loading-text="正在查询中......" >查询可用车辆</button>											</div>										</div>																													<div class="control-group">											<label class="control-label">可用车型<span class="required">*</span></label>												<div class="controls" id="available_cars_container">																																																																								<div id="form_2_membership_error"></div><!--												<label class="radio line">													<input type="radio" name="optionsRadios2" value="option1" />													Option 1												</label>												<label class="radio line">													<input type="radio" name="optionsRadios2" value="option2"  disabled="disabled"/>													Option 2												</label>  																									<label class="radio line">													<input type="radio" name="optionsRadios2" value="option2" />													Option 3												</label>  	-->																								</div>									</div>																	<div class="control-group">										<label class="control-label">会员信息<span class="required">*</span></label>										<div class="controls">											<!--											（剩余：<span class="residue"><?php echo ($count_day["residue"]); ?></span>天 ）|											 -->											（已使用：<span class="residue"><?php echo ($count_day["use"]); ?></span>天） | 											（总：<span class="residue"><?php echo ($count_day["sum"]); ?></span>天） | 																						（会员到期时间：<span class="residue" id="over_date"><?php echo ($over_date); ?></span>）										</div>									</div>																		<div class="control-group">										<label class="control-label">是否需要司机<span class="required">*</span></label>											<div class="controls">												<select class="small m-wrap" tabindex="1" name="is_need_driver">																										<?php if(is_array($is_need_driver)): $i = 0; $__LIST__ = $is_need_driver;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($html_info['is_need_driver'] == $vo['id'])): ?><option value="<?php echo ($vo["id"]); ?>" selected="selected"><?php echo ($vo["name"]); ?></option>														<?php else: ?>															<option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>															</select>											</div>									</div>																			<div class="control-group">										<label class="control-label">备注：</label>										<div class="controls">											<textarea rows="3" name="remarks" class="span6 m-wrap"><?php echo ($html_info["remarks"]); ?></textarea>										</div>									</div>									
									<div class="form-actions">										
										<button type="submit" class="btn purple">提交</button>
										<a href="?s=/Admin/Member/all_user_info.html"><button type="button" class="btn">返回会员查询页</button></a>																				<a href="?s=/Admin/Order/apply.html"><button type="button" class="btn">返回订单页</button></a>																				
									</div>
								</form>
								<!-- END FORM-->
							</div>
...
-->
	...
	<script src="<?php echo (APP_PATH); ?>Public/media/js/form-validation_Order_edit_apply.js"></script> 	<!-- END PAGE LEVEL STYLES -->    
	<script>
