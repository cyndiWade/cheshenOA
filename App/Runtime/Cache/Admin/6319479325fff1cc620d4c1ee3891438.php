...
-->
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-globe"></i>注册用户列表</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">																		<a href="?s=/Admin/Member/member_edit/act/add">
								...
								<table class="table table-striped table-bordered table-hover sample_1">
									...
									<tbody>																		<?php if(is_array($member_list)): $i = 0; $__LIST__ = $member_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
											<td><?php echo ($vo["id"]); ?></td>
											<td class="hidden-480"><?php echo ($vo["account"]); ?></a></td>
											<td class="hidden-480"><?php echo ($vo["nickname"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["last_login_time"]); ?></td>
											<td class="center hidden-480"><?php echo ($vo["login_count"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["create_time"]); ?></td>
											<td >												<a href="?s=/Admin/Member/member_edit/act/update/id/<?php echo ($vo["id"]); ?>">编辑</a>												| <a href="?s=/Admin/Member/member_edit/act/delete/id/<?php echo ($vo["id"]); ?>" class="check">删除</a>																							</td>
	...
	<script type="text/javascript" src="<?php echo (APP_PATH); ?>Public/media/js/app.js"></script>	<script type="text/javascript" src="<?php echo (APP_PATH); ?>Public/media/js/table-managed-Member-user_list.js"></script>   	
