					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">																		<a href="?s=/Admin/ReserveTalents/edit/act/add/">
								...
								<table class="table table-striped table-bordered table-hover sample_1">
									<thead>
										<tr>
											...
											<th class="hidden-480">应聘岗位</th>
											<th class="hidden-480">联系电话</th>											<th class="hidden-480">包括身份证号</th>	
											<th >操作</th>
										</tr>
									</thead>
									<tbody>																		<?php if(is_array($html_list)): $i = 0; $__LIST__ = $html_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
											...
											<td class="hidden-480"><?php echo ($vo["sex"]); ?></a></td>					
											<td class="hidden-480"><?php echo ($vo["jobs"]); ?></td>											<td class="hidden-480"><?php echo ($vo["phone"]); ?></td>											<td class="hidden-480"><?php echo ($vo["identity"]); ?></td>
											<td >												<a href="?s=/Admin/ReserveTalents/edit/act/update/id/<?php echo ($vo["id"]); ?>">编辑</a>												| <a href="?s=/Admin/ReserveTalents/edit/act/delete/id/<?php echo ($vo["id"]); ?>" class="check">删除</a>																							</td>
...
-->
	...
	<script type="text/javascript" src="<?php echo (APP_PATH); ?>Public/media/js/app.js"></script>   	<script type="text/javascript" src="<?php echo (APP_PATH); ?>Public/media/js/table-managed-ReserveTalents-index.js"></script>	
