				...
				<li class="">
					...
					<ul class="sub-menu">
						...
						<li >
							...
							<a href="<?php echo U('Admin/Driver/index');?>">
							司机管理</a>
						</li>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i><?php echo ($TITLE_NAME); ?></div>
								<div class="tools">
							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_1" method="post" class="form-horizontal">		
									...
									<div class="alert alert-success hide">
										<button class="close" data-dismiss="alert"></button>
										验证成功
									</div>																																	<div class="control-group">																<label class="control-label">应聘岗位<span class="required">*</span></label>																<div class="controls">																	<input type="text" class="span6 m-wrap" data-required="1"name="jobs"  value="<?php echo ($html_info["jobs"]); ?>" >																</div>															</div>																								<div class="control-group">																<label class="control-label">姓名<span class="required">*</span></label>																<div class="controls">																	<input type="text" class="span6 m-wrap" data-required="1"name="name"  value="<?php echo ($html_info["name"]); ?>" >																</div>															</div>																								<div class="control-group">																<label class="control-label">英文姓名<span class="required">*</span></label>																<div class="controls">																	<input type="text" class="span6 m-wrap" data-required="1"name="name_en"  value="<?php echo ($html_info["name_en"]); ?>" >																</div>															</div>																	<div class="control-group">																<label class="control-label">民族</label>																<div class="controls">																	<input type="text" class="span6 m-wrap" data-required="1" value="<?php echo ($html_info["ethnic"]); ?>" name="ethnic">																</div>															</div>																								<div class="control-group">																<label class="control-label">身份证号码</label>																<div class="controls">																	<input type="text" class="span6 m-wrap"   name="identity" value="<?php echo ($html_info["identity"]); ?>">																</div>															</div>																																				<div class="control-group">																<label class="control-label">身份证地址</label>																<div class="controls">																	<input type="text" class="span6 m-wrap"   name="identity_address" value="<?php echo ($html_info["identity_address"]); ?>">																</div>															</div>																								<div class="control-group">																<label class="control-label">居住地址</label>																<div class="controls">																	<input type="text" class="span6 m-wrap" data-required="1" value="<?php echo ($html_info["dwell_address"]); ?>" name="dwell_address">																</div>															</div>																								<div class="control-group">													<?php if(($html_info['sex'] == '男') ): $sex_man = 'checked=checked'; ?>													<?php else: ?>														<?php $sex_woman = 'checked=checked'; endif; ?>																										<label class="control-label">性别</label>																<div class="controls">																	<label class="radio">																	<div class="radio"><span><input type="radio" name="sex" value="男" <?php echo ($sex_man); ?>></span></div>																	男																	</label>																	<label class="radio">																	<div class="radio"><span class="checked"><input type="radio" name="sex" value="女"  <?php echo ($sex_woman); ?>></span></div>																女														</label>  																</div>															</div>																								<div class="control-group">																<label class="control-label">血型</label>																<div class="controls">																	<input type="text" class="span6 m-wrap" data-required="1"  name="blood" value="<?php echo ($html_info["blood"]); ?>">																</div>															</div>																								<div class="control-group">																<label class="control-label">身高</label>																<div class="controls">																	<input type="text" class="span6 m-wrap" data-required="1"  name="height" value="<?php echo ($html_info["height"]); ?>">																</div>															</div>														<div class="control-group">																<label class="control-label">生日</label>																<div class="controls">																	<input type="text" class="span6 m-wrap"   name="birthday" value="<?php echo ($html_info["birthday"]); ?>">																</div>															</div>																								<div class="control-group">																<label class="control-label">年龄</label>																<div class="controls">																	<input type="text" class="span6 m-wrap"   name="age" value="<?php echo ($html_info["age"]); ?>">																</div>															</div>																								<div class="control-group">																<label class="control-label">学历</label>																<div class="controls">																	<input type="text" class="span6 m-wrap" data-required="1"  name="education" value="<?php echo ($html_info["education"]); ?>">																</div>															</div>																								<div class="control-group">																<label class="control-label">专业</label>																<div class="controls">																	<input type="text" class="span6 m-wrap" data-required="1"  name="major" value="<?php echo ($html_info["major"]); ?>">																</div>															</div>																								<div class="control-group">																<label class="control-label">祖籍</label>																<div class="controls">																	<input type="text" class="span6 m-wrap" data-required="1"  name="ancestral" value="<?php echo ($html_info["ancestral"]); ?>">																</div>															</div>																								<div class="control-group">																<label class="control-label">政治面貌</label>																<div class="controls">																	<input type="text" class="span6 m-wrap" data-required="1"  name="politics" value="<?php echo ($html_info["politics"]); ?>">																</div>															</div>																								<div class="control-group">																<label class="control-label">电子邮箱</label>																<div class="controls">																	<input type="text" class="span6 m-wrap" data-required="1"  name="email" value="<?php echo ($html_info["email"]); ?>">																</div>															</div>																								<div class="control-group">																<label class="control-label">电话号码</label>																<div class="controls">																	<input type="text" class="span6 m-wrap" data-required="1"  name="phone" value="<?php echo ($html_info["phone"]); ?>">																</div>															</div>												<div class="control-group">													<label class="control-label">备注</label>																<div class="controls">																	<textarea rows="3" class="span6 m-wrap" name="remarks"><?php echo ($html_info["remarks"]); ?></textarea>																</div>															</div>															<div class="form-actions">																										<button class="btn purple" type="submit">编辑</button>																<a href="?s=/Admin/ReserveTalents/index.html"><button class="btn" type="button">返回</button></a>															</div>
								</form>
								<!-- END FORM-->
							</div>
						</div>
...
-->
	...
	<!-- BEGIN PAGE LEVEL STYLES -->
	<script src="<?php echo (APP_PATH); ?>Public/media/js/app.js"></script>	<script type="text/javascript"  src="<?php echo (APP_PATH); ?>Public/media/js/form-validation-ReserveTalents-edit.js"></script>	<!-- END PAGE LEVEL STYLES -->    
