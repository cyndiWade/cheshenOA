...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo (APP_PATH); ?>Public/media/css/chosen.css" />		<link rel="stylesheet" type="text/css" href="<?php echo (APP_PATH); ?>Public/media/css/flick/jquery-ui-1.10.3.custom.css" />	
							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_1" method="post" class="form-horizontal">					 				<input type="hidden" name="id" value="<?php echo ($credit_info["id"]); ?>" />									
									...
									<div class="alert alert-success hide">
										<button class="close" data-dismiss="alert"></button>
										验证成功
									</div>																											<div class="control-group">										<label class="control-label">信用卡最高金额<span class="required">*</span></label>										<div class="controls">											<div class="input-prepend input-append">												<span class="add-on">$</span>												<input type="text" class="m-wrap" name="credit_card" value="<?php echo ($credit_info["credit_card"]); ?>">												<span class="add-on">.00</span>											</div>										</div>									</div>										<div class="control-group">										<label class="control-label">所属银行<span class="required">*</span></label>										<div class="controls">											<input type="text" name="bank" value="<?php echo ($credit_info["bank"]); ?>" data-required="1" class="span6 m-wrap"/>										</div>									</div>									<div class="control-group">																	<label class="control-label">最高级别车</label>										<div class="controls">											<div class="row-fluid">												<div class="span3">													<label class="checkbox line">													<div>														<span>品　　牌：<input type="text" name="car[brand]" value="<?php echo ($credit_info['car']->brand); ?>" data-required="1" class="span6 m-wrap"/></span>													</div> 													</label>																										<label class="checkbox line">													<div>														<span>车牌号码：<input type="text" name="car[number]" value="<?php echo ($credit_info['car']->number); ?>" data-required="1" class="span6 m-wrap"/></span>													</div> 													</label>												</div>																								<div class="span3">													<label class="checkbox line">													<div>														<span>型　　号：<input type="text" name="car[model]" value="<?php echo ($credit_info['car']->model); ?>" data-required="1" class="span6 m-wrap"/></span>													</div> 													</label>																										<label class="checkbox line">													<div>																												<span>															购车时间：<input type="text" name="car[time]" value="<?php echo ($credit_info['car']->time); ?>"  readonly="" class="span6 wade_date"><span class="add-on"><i class="icon-calendar"></i></span>														</span>																								</div> 													</label>												</div>																							</div>										</div>									</div>									<div class="control-group">										<label class="control-label">房（现居住）</label>																				<div class="controls">											<label class="checkbox line">											<div >												<span >详细地址：<input type="text" name="house[site]" value="<?php echo ($credit_info['house']->site); ?>" class="span5 m-wrap"/></span>											</div>											</label>											<label class="checkbox line">											<div>												<span>面　　积：<input type="text" name="house[area]" value="<?php echo ($credit_info['house']->area); ?>" class="span2 m-wrap"/></span>											</div>											</label>										</div>									</div>																														<div class="control-group">										<label class="control-label">其他：</label>										<div class="controls">											<textarea rows="3" name="other" class="span6 m-wrap"><?php echo ($credit_info["other"]); ?></textarea>										</div>									</div>									<div class="control-group">										<label class="control-label">需要哪些资源给予支持：</label>										<div class="controls">											<textarea rows="3" name="help" class="span6 m-wrap"><?php echo ($credit_info["help"]); ?></textarea>										</div>									</div>																		<div class="control-group">										<label class="control-label">您有哪些资源可以共享：</label>										<div class="controls">											<textarea rows="3" name="share" class="span6 m-wrap"><?php echo ($credit_info["share"]); ?></textarea>										</div>									</div>
...
-->
	...
	<!-- BEGIN PAGE LEVEL STYLES -->
	<script src="<?php echo (APP_PATH); ?>Public/media/js/app.js"></script>	<script src="<?php echo (APP_PATH); ?>Public/media/js/form-validation_member_credit.js"></script> 
	<!-- END PAGE LEVEL STYLES -->    
	<script>
