...
-->
					...
					<li class="dropdown user">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="<?php echo U('Admin/User/personal#tab_3-3');?>"><i class="icon-key"></i>修改密码</a></li>
			...
			<ul class="page-sidebar-menu wade_menu">
				...
				<li class="">
					...
					<ul class="sub-menu">
						...
						<li >
							<a href="<?php echo U('Admin/Order/give_back_car');?>">
							还车管理</a>
						</li>
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
								<a href="__APP__/Admin/Index/index">首页</a> 
						...
						<div class="tabbable tabbable-custom tabbable-full-width">
							...
							<div class="tab-content">
								...
								<div class="tab-pane   profile-classic row-fluid  active" id="tab_1_1">
									...
									<ul class="unstyled span10">										<li><span>编号:</span> JDuser</li>
										<li><span>用户名:</span> JDuser</li>
										<li><span>英文名称:</span> John</li>																				<li><span>性别:</span> 男</li>
										<!--<li><span>Last Name:</span> Doe</li>
										<li><span>Counrty:</span> Spain</li>-->
										<li><span>部门:</span> 18 Jan 1982</li>
										<li><span>职位:</span> Web Developer</li>
										<li><span>Email:</span> <a href="#">john@mywebsite.com</a></li>
										<li><span>电话:</span> 11111111</li>
										<li><span>居住地:</span> ######</li>
										<li><span>紧急联系电话:</span> +1 646 580 DEMO (6284)</li>
										<li><span>备注:</span> ######.</li>
									</ul>
								</div>
								<!--tab_1_2-->
														...
														<div style="height: auto;" id="accordion3-3" class="accordion collapse">
															<form method="post" name="passwordform" action="__APP__/Admin/User/modifi_password">
																...
																<div class="submit-btn">
																	...
																	<a href="javascript:document.passwordform.reset();" class="btn">取消</a>
																</div>
															</form>
														</div>
													</div>
