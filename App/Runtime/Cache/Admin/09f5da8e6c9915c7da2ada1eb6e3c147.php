					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">																		<a href="?s=/Admin/CarsCompany/car_info/act/add/company_id/<?php echo ($company_id); ?>.html">
								...
								<table class="table table-striped table-bordered table-hover sample_1">
									<thead>
										<tr>
											<th>车辆号</th>
											<th class="hidden-480">车辆品牌</th>
											<th class="hidden-480">车辆型号</th>
											<th class="hidden-480">车辆牌照</th>											<th class="hidden-480">车辆状态</th>											<th class="hidden-480">标签</th>
											<th >操作</th>
										</tr>
									</thead>
									<tbody>																		<?php if(is_array($html_list)): $i = 0; $__LIST__ = $html_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
											...
											<td class="hidden-480"><?php echo ($vo["brand"]); ?></a></td>
											<td class="hidden-480"><?php echo ($vo["type"]); ?></td>											<td class="center hidden-480"><?php echo ($vo["car_num"]); ?></td>
											<td class="center hidden-480"><?php echo ($vo["car_status"]); ?></td>											<td class="center">												<a href="?s=/Admin/CarsCompany/cars_photo/company_id/<?php echo ($vo["company_id"]); ?>/cars_id/<?php echo ($vo["id"]); ?>.html">上传图片</a>												| <a href="?s=/Admin/CarsAudit/index/cars_id/<?php echo ($vo["id"]); ?>.html">年检情况</a>												| <a href="?s=/Admin/CarsInsurance/index/cars_id/<?php echo ($vo["id"]); ?>.html">保险情况</a>																		| <a href="?s=/Admin/CarsSchedule/index/cars_id/<?php echo ($vo["id"]); ?>.html">日程安排</a>											</td>
											<td >												<a href="?s=/Admin/CarsCompany/car_info/act/update/company_id/<?php echo ($vo["company_id"]); ?>/id/<?php echo ($vo["id"]); ?>.html">编辑</a>												| <a href="?s=/Admin/CarsCompany/car_info/act/delete/company_id/<?php echo ($vo["company_id"]); ?>/id/<?php echo ($vo["id"]); ?>.html" class="check">删除</a>											</td>
...
-->
	...
	<script type="text/javascript" src="<?php echo (APP_PATH); ?>Public/media/js/app.js"></script>		<script type="text/javascript" src="<?php echo (APP_PATH); ?>Public/media/js/table-managed-CarsCompany-car_index.js"></script>   
